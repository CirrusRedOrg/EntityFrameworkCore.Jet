...
public class ComparisonOperatorTranslationsJetTest : ComparisonOperatorTranslationsTestBase<BasicTypesQueryJetFixture>
{
    public ComparisonOperatorTranslationsJetTest(BasicTypesQueryJetFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
