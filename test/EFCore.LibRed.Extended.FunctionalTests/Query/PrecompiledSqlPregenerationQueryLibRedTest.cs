...
public class PrecompiledSqlPregenerationQueryLibRedTest(
    PrecompiledSqlPregenerationQueryLibRedTest.PrecompiledSqlPregenerationQueryLibRedFixture fixture,
    ITestOutputHelper testOutputHelper)
    : PrecompiledSqlPregenerationQueryRelationalTestBase(fixture, testOutputHelper),
        IClassFixture<PrecompiledSqlPregenerationQueryLibRedTest.PrecompiledSqlPregenerationQueryLibRedFixture>
{
...
""");
    ...
    public override async Task Non_nullable_reference_type()
    {
        ...
        AssertSql(
            """
@name='bar' (Nullable = false) (Size = 255)
...
""");
    ...
    public override async Task Two_non_nullable_reference_types()
    {
        ...
        AssertSql(
            """
@name1='foo' (Nullable = false) (Size = 255)
@name2='bar' (Nullable = false) (Size = 255)
...
@name1='foo' (Nullable = false) (Size = 255)
@name2='bar' (Nullable = false) (Size = 255)
@name3='baz' (Nullable = false) (Size = 255)
@name4='baq' (Nullable = false) (Size = 255)
...
""",
    ...
    public class PrecompiledSqlPregenerationQueryLibRedFixture : PrecompiledSqlPregenerationQueryRelationalFixture
    {
        ...
        /*public override DbContextOptionsBuilder AddOptions(DbContextOptionsBuilder builder)
        {
            ...
            var jetOptionsBuilder = new LibRedDbContextOptionsBuilder(builder);
            jetOptionsBuilder
                .ExecutionStrategy(d => new NonRetryingExecutionStrategy(d));
            return builder;
        }*/

        public override PrecompiledQueryTestHelpers PrecompiledQueryTestHelpers => LibRedPrecompiledQueryTestHelpers.Instance;
    }
}
