...
{
    public class IncludeOneToOneLibRedTest : IncludeOneToOneTestBase<IncludeOneToOneLibRedTest.OneToOneQueryLibRedFixture>
    {
        public IncludeOneToOneLibRedTest(OneToOneQueryLibRedFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
        ...
        public class OneToOneQueryLibRedFixture : OneToOneQueryFixtureBase
        {
