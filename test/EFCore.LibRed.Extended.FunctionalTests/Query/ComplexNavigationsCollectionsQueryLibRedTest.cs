...
public class ComplexNavigationsCollectionsQueryLibRedTest
    : ComplexNavigationsCollectionsQueryRelationalTestBase<ComplexNavigationsQueryLibRedFixture>
{
    public ComplexNavigationsCollectionsQueryLibRedTest(
...
ORDER BY `l`.`Id`, `s0`.`Id`, `s0`.`Id0`, `s0`.`Id1`
""");
    }
...
ORDER BY `l1`.`Name`, `l1`.`Id`, `l2`.`Id`, `l3`.`Id`
""");
    }
...
ORDER BY `l1`.`Name`, `l1`.`Id`, `l3`.`Id`, `l4`.`Id`
""");
    }
...
FROM (
    ...
    FROM `LevelOne` AS `l`
    GROUP BY `l`.`Name`
    HAVING `l`.`Name` <> 'Foo' OR `l`.`Name` IS NULL
) AS `l2`
LEFT JOIN (
    SELECT `l3`.`Id`, `l3`.`Date`, `l3`.`Name`, `l3`.`OneToMany_Optional_Self_Inverse1Id`, `l3`.`OneToMany_Required_Self_Inverse1Id`, `l3`.`OneToOne_Optional_Self1Id`
    FROM (
...
ORDER BY `l`.`Id`, `s`.`Id`, `s`.`Name0`, `s`.`Id0`
""");
    }
...
ORDER BY `l`.`Id`, `s`.`Name`, `s`.`Id`, `s`.`Name0` DESC, `s`.`Id0`
""");
    }
...
ORDER BY `l`.`Id`, `l2`.`OneToMany_Optional_Inverse2Id`, `l2`.`Name`, `l2`.`Id`
""");
    }
...
ORDER BY `l`.`Id`, `l3`.`OneToMany_Optional_Inverse3Id`, `l3`.`Name`, `l3`.`Id`
""");
    }
...
ORDER BY `l`.`Id`, `l3`.`OneToMany_Optional_Inverse2Id`, `l3`.`Name`, `l3`.`Id`, `l5`.`OneToMany_Required_Inverse2Id`, `l5`.`Name` DESC, `l5`.`Id`
""");
    }
...
ORDER BY `l`.`Id`, `s`.`Name`, `s`.`Id`, `s`.`OneToMany_Required_Inverse3Id`, `s`.`Name0` DESC, `s`.`Id0`
""");
    }
...
ORDER BY `l`.`Id`, `s0`.`Id`, `s0`.`Id0`, `s0`.`Id00`, `s0`.`Id1`
""");
    }
...
ORDER BY `l`.`Id`, `s`.`Id`, `s`.`Id0`, `s0`.`Id`, `s0`.`Id0`
""");
    }
...
ORDER BY `l1`.`Date`, `l3`.`Date`, `l3`.`Name`, `l3`.`Id`
""");
    }
...
ORDER BY `l1`.`Date`, `l3`.`Date`, `l3`.`Name` DESC, `l3`.`Id`
""");
    }
...
ORDER BY `l2`.`Date`, `s`.`Name`, `s`.`Id`, `s`.`Id0`
""");
    }
...
ORDER BY `l`.`Id`, `s`.`Date`, `s`.`Date0`, `s`.`Name`, `s`.`Id`
""");
    }
...
WHERE `l0`.`Id` < 3 OR `l1`.`Id` > 8
ORDER BY `l`.`Id`, `l6`.`OneToMany_Optional_Inverse3Id`, `l6`.`Id`, `s`.`Id`
""");
    }
...
OUTER APPLY (
    SELECT `l0`.`Id`, `l0`.`Date`, `l0`.`Level1_Optional_Id`, `l0`.`Level1_Required_Id`, `l0`.`Name`, `l0`.`OneToMany_Optional_Inverse2Id`, `l0`.`OneToMany_Optional_Self_Inverse2Id`, `l0`.`OneToMany_Required_Inverse2Id`, `l0`.`OneToMany_Required_Self_Inverse2Id`, `l0`.`OneToOne_Optional_PK_Inverse2Id`, `l0`.`OneToOne_Optional_Self2Id`
    FROM `LevelTwo` AS `l0`
    WHERE `l0`.`Level1_Required_Id` = (`l`.`Id` * 2) OR LEN(`l0`.`Name`) = `l0`.`Id`
) AS `l1`
LEFT JOIN `LevelTwo` AS `l2` ON `l`.`Id` = `l2`.`OneToMany_Optional_Inverse2Id`
ORDER BY `l`.`Id`, `l1`.`Id`, `l2`.`Id`
""");
    ...
    public override async Task Complex_query_issue_21665(bool async)
    {
        ...
        AssertSql(
            """
SELECT `s`.`Id`, `s`.`Date`, `s`.`Name`, `s`.`OneToMany_Optional_Self_Inverse1Id`, `s`.`OneToMany_Required_Self_Inverse1Id`, `s`.`OneToOne_Optional_Self1Id`, `s`.`Name0`, `s`.`c`, `s`.`c0`, `s`.`c1`, `s0`.`Id`, `s0`.`Date`, `s0`.`Name`, `s0`.`OneToMany_Optional_Self_Inverse1Id`, `s0`.`OneToMany_Required_Self_Inverse1Id`, `s0`.`OneToOne_Optional_Self1Id`, `s0`.`ChildCount`, `s0`.`Level2Name`, `s0`.`Level2Count`, `s0`.`IsLevel2There`
FROM (
    SELECT TOP 1 `l`.`Id`, `l`.`Date`, `l`.`Name`, `l`.`OneToMany_Optional_Self_Inverse1Id`, `l`.`OneToMany_Required_Self_Inverse1Id`, `l`.`OneToOne_Optional_Self1Id`, `l0`.`Name` AS `Name0`, (
        ...
        SELECT COUNT(*)
        FROM `LevelTwo` AS `l2`
        WHERE `l`.`Id` = `l2`.`OneToMany_Optional_Inverse2Id`) AS `c0`, EXISTS (
        SELECT 1
        FROM `LevelTwo` AS `l3`
        WHERE `l`.`Id` = `l3`.`OneToMany_Optional_Inverse2Id` AND `l3`.`Id` = 2) AS `c1`
    FROM `LevelOne` AS `l`
    LEFT JOIN `LevelTwo` AS `l0` ON `l`.`Id` = `l0`.`Level1_Optional_Id`
    WHERE `l`.`Id` = 2
    ORDER BY `l`.`Name`
...
OUTER APPLY (
    SELECT `l6`.`Id`, `l6`.`Date`, `l6`.`Name`, `l6`.`OneToMany_Optional_Self_Inverse1Id`, `l6`.`OneToMany_Required_Self_Inverse1Id`, `l6`.`OneToOne_Optional_Self1Id`, (
        ...
        SELECT COUNT(*)
        FROM `LevelTwo` AS `l8`
        WHERE `l6`.`Id` = `l8`.`OneToMany_Optional_Inverse2Id`) AS `Level2Count`, EXISTS (
        SELECT 1
        FROM `LevelTwo` AS `l9`
        WHERE `l6`.`Id` = `l9`.`OneToMany_Optional_Inverse2Id` AND `l9`.`Id` = 2) AS `IsLevel2There`
    FROM (
...
ORDER BY `s`.`Name`, `s`.`Id`, `s0`.`Name`, `s0`.`Id`
""");
    }
...
""");
    ...
    public override async Task Complex_query_with_let_collection_projection_FirstOrDefault_with_ToList_on_inner_and_outer(bool async)
    {
        ...
        AssertSql(
            """
SELECT `l`.`Id`, `l4`.`Name`, `l4`.`Id`, `l3`.`c`
FROM `LevelOne` AS `l`
OUTER APPLY (
...
""");
    ...
    public override async Task Projecting_collection_after_optional_reference_correlated_with_parent(bool async)
    {
        ...
        AssertSql(
            """
SELECT `l`.`Id`, `l2`.`ChildId`, `l2`.`ParentName`
FROM `LevelOne` AS `l`
LEFT JOIN `LevelTwo` AS `l0` ON `l`.`Id` = `l0`.`Level1_Optional_Id`
OUTER APPLY (
...
""");
    ...
    public override async Task Projecting_collection_with_group_by_after_optional_reference_correlated_with_parent(bool async)
    {
        ...
        AssertSql(
            """
SELECT `l`.`Id`, `l1`.`Id`, `l1`.`Level2_Optional_Id`, `l1`.`Level2_Required_Id`, `l1`.`Name`, `l1`.`OneToMany_Optional_Inverse3Id`, `l1`.`OneToMany_Optional_Self_Inverse3Id`, `l1`.`OneToMany_Required_Inverse3Id`, `l1`.`OneToMany_Required_Self_Inverse3Id`, `l1`.`OneToOne_Optional_PK_Inverse3Id`, `l1`.`OneToOne_Optional_Self3Id`, `l3`.`Key`, `l3`.`Count`
FROM `LevelOne` AS `l`
LEFT JOIN `LevelTwo` AS `l0` ON `l`.`Id` = `l0`.`Level1_Optional_Id`
LEFT JOIN `LevelThree` AS `l1` ON `l0`.`Id` = `l1`.`Level2_Optional_Id`
OUTER APPLY (
...
ORDER BY `l`.`Name`, `l`.`Id`, `s`.`Id`, `s`.`Id0`
""");
    }
