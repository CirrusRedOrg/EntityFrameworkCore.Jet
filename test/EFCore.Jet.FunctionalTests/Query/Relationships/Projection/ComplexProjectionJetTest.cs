...
public class ComplexProjectionJetTest
    : ComplexProjectionRelationalTestBase<ComplexRelationshipsJetFixture>
{
    public ComplexProjectionJetTest(ComplexRelationshipsJetFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
