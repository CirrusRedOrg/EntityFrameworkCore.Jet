...
public class OwnedJsonCollectionLibRedTest(OwnedJsonLibRedFixture fixture, ITestOutputHelper testOutputHelper)
    : OwnedJsonCollectionRelationalTestBase<OwnedJsonLibRedFixture>(fixture, testOutputHelper)
{
