...
public class TPHInheritanceBulkUpdatesLibRedTest(
    TPHInheritanceBulkUpdatesLibRedFixture fixture,
    ITestOutputHelper testOutputHelper)
    : TPHInheritanceBulkUpdatesTestBase<TPHInheritanceBulkUpdatesLibRedFixture>(fixture, testOutputHelper)
{
    [ConditionalFact]
