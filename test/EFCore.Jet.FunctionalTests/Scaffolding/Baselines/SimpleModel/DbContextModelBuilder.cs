...
namespace TestNamespace
{
    public partial class DbContextModel
    {
        ...
        private IRelationalModel CreateRelationalModel()
        {
            ...
            var dataColumnBase = new ColumnBase<ColumnMappingBase>("Data", "varchar(255)", microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBaseDependentDerivedintTableBase)
            {
                IsNullable = true
            };
            ...
            var dataColumn = new Column("Data", "varchar(255)", dependentDerivedintTable)
            {
                IsNullable = true
            };
