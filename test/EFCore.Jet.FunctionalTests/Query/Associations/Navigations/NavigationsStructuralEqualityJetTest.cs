...
public class NavigationsStructuralEqualityJetTest(
    NavigationsJetFixture fixture,
    ITestOutputHelper testOutputHelper)
    : NavigationsStructuralEqualityRelationalTestBase<NavigationsJetFixture>(fixture, testOutputHelper)
{
