...
public class ComplexJsonProjectionJetTest(ComplexJsonJetFixture fixture, ITestOutputHelper testOutputHelper)
    : ComplexJsonProjectionRelationalTestBase<ComplexJsonJetFixture>(fixture, testOutputHelper)
{
