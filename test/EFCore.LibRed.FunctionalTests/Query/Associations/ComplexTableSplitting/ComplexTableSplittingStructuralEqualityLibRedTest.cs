...
public class ComplexTableSplittingStructuralEqualityLibRedTest(
    ComplexTableSplittingLibRedFixture fixture,
    ITestOutputHelper testOutputHelper)
    : ComplexTableSplittingStructuralEqualityRelationalTestBase<ComplexTableSplittingLibRedFixture>(fixture, testOutputHelper)
{
...
@entity_equality_nested_Ints='[1,2,3]' (Size = 255)
@entity_equality_nested_Name='Root1_RequiredAssociate_RequiredNestedAssociate' (Size = 255)
@entity_equality_nested_String='foo' (Size = 255)
