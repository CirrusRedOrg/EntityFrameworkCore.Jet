...
namespace EntityFrameworkCore.LibRed.Extended.FunctionalTests.Update;

public class MismatchedKeyTypesLibRedTest(MismatchedKeyTypesLibRedTest.MismatchedKeyTypesLibRedFixture fixture)
    : IClassFixture<MismatchedKeyTypesLibRedTest.MismatchedKeyTypesLibRedFixture>
{
    ...
    protected class MismatchedKeyTypesContextNoFks(MismatchedKeyTypesLibRedFixture fixture) : MismatchedKeyTypesContext(fixture)
    {
    ...
    protected class MismatchedKeyTypesContext(MismatchedKeyTypesLibRedFixture fixture) : DbContext
    {
        public MismatchedKeyTypesLibRedFixture Fixture { get; } = fixture;
    ...
    public class MismatchedKeyTypesLibRedFixture : IAsyncLifetime
    {
