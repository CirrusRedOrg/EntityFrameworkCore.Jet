...
{
    public class SqlExecutorLibRedTest : SqlExecutorTestBase<NorthwindQueryLibRedFixture<SqlExecutorModelCustomizer>>
    {
        // ReSharper disable once UnusedParameter.Local
        public SqlExecutorLibRedTest(NorthwindQueryLibRedFixture<SqlExecutorModelCustomizer> fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
