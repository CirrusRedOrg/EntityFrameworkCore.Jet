...
public abstract class StoreValueGenerationTriggerJetTestBase<TFixture> : StoreValueGenerationTestBase<TFixture>
    where TFixture : StoreValueGenerationTriggerJetFixture
{
    protected StoreValueGenerationTriggerJetTestBase(TFixture fixture)
        : base(fixture)
    {
    }
