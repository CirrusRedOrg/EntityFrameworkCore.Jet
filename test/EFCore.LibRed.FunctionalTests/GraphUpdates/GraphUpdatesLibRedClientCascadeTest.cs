...
public class GraphUpdatesLibRedClientCascadeTest(GraphUpdatesLibRedClientCascadeTest.LibRedFixture fixture)
    : GraphUpdatesLibRedTestBase<
        GraphUpdatesLibRedClientCascadeTest.LibRedFixture>(fixture)
{
