...
namespace EntityFrameworkCore.LibRed.Extended.FunctionalTests.TestModels.Northwind
{
    public class NorthwindLibRedContext(DbContextOptions options) : NorthwindRelationalContext(options)
    {
