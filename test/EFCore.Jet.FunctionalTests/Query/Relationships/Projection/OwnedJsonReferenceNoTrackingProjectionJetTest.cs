...
public class OwnedJsonReferenceNoTrackingProjectionJetTest
    : OwnedJsonReferenceNoTrackingProjectionRelationalTestBase<OwnedJsonRelationshipsJetFixture>
{
    public OwnedJsonReferenceNoTrackingProjectionJetTest(OwnedJsonRelationshipsJetFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
