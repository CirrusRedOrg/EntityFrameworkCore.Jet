...
public class NavigationProjectionJetTest
    : NavigationProjectionRelationalTestBase<NavigationRelationshipsJetFixture>
{
    public NavigationProjectionJetTest(NavigationRelationshipsJetFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
