...
{
    public class LazyLoadProxyLibRedTest : LazyLoadProxyRelationalTestBase<LazyLoadProxyLibRedTest.LoadLibRedFixture>
    {
        public LazyLoadProxyLibRedTest(LoadLibRedFixture fixture)
            : base(fixture)
        {
...
";
        ...
        public class LoadLibRedFixture : LoadRelationalFixtureBase
        {
