...
public class ComplexTableSplittingMiscellaneousLibRedTest(
    ComplexTableSplittingLibRedFixture fixture,
    ITestOutputHelper testOutputHelper)
    : ComplexTableSplittingMiscellaneousRelationalTestBase<ComplexTableSplittingLibRedFixture>(fixture, testOutputHelper)
{
