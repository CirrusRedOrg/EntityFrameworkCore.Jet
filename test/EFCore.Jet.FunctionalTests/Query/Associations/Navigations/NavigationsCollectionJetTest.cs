...
public class NavigationsCollectionJetTest(NavigationsJetFixture fixture, ITestOutputHelper testOutputHelper)
    : NavigationsCollectionRelationalTestBase<NavigationsJetFixture>(fixture, testOutputHelper)
{
