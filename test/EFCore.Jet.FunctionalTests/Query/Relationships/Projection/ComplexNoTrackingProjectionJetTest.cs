...
public class ComplexNoTrackingProjectionJetTest
    : ComplexNoTrackingProjectionRelationalTestBase<ComplexRelationshipsJetFixture>
{
    public ComplexNoTrackingProjectionJetTest(ComplexRelationshipsJetFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
