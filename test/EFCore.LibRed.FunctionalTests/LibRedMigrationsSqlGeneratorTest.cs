...
namespace EntityFrameworkCore.LibRed.FunctionalTests
{
    ...
    public class LibRedMigrationsSqlGeneratorTest() : MigrationsSqlGeneratorTestBase(LibRedTestHelpers.Instance,
        new ServiceCollection(),
        LibRedTestHelpers.Instance.AddProviderOptions(
            ...
            .OptionsBuilder).Options)
    {
        ...
        //         {
        //             Generate(
        //                 new LibRedCreateDatabaseOperation { Name = "Northwind", FileName = "Narf.mdf" });
        //
        ...
        //
        //             Generate(
        //                 new LibRedCreateDatabaseOperation { Name = "Northwind", FileName = "|DataDirectory|Narf.mdf" });
        //
        ...
        public virtual void RenameIndexOperations_throws_when_no_table()
        {
            ...
            var ex = Assert.Throws<InvalidOperationException>(
                () => Generate([.. migrationBuilder.Operations]));
        ...
        /*.AddEntityFrameworkLibRedNetTopologySuite()*/
        /*.UseNetTopologySuite()*/
    }
}
