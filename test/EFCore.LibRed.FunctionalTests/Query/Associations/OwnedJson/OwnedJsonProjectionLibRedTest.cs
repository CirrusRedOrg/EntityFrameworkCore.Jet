...
public class OwnedJsonProjectionLibRedTest(OwnedJsonLibRedFixture fixture, ITestOutputHelper testOutputHelper)
    : OwnedJsonProjectionRelationalTestBase<OwnedJsonLibRedFixture>(fixture, testOutputHelper)
{
