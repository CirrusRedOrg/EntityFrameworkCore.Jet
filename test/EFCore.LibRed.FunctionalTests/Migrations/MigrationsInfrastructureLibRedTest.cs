...
""",
        ...
        {
            await Assert.ThrowsAsync<NotSupportedException>(async () => await base.Can_generate_idempotent_up_and_down_scripts());
        }

        public override async Task Can_generate_idempotent_up_and_down_scripts_noTransactions()
        {
            await Assert.ThrowsAsync<NotSupportedException>(async () => await base.Can_generate_idempotent_up_and_down_scripts_noTransactions());
        }
        ...
        public async Task Empty_Migration_Creates_Database()
        {
            ...
            var creator = (LibRedDatabaseCreator)context.GetService<IRelationalDatabaseCreator>();
...
#pragma warning disable 612, 618
                ...
                modelBuilder.Entity("Microsoft.EntityFrameworkCore.Migrations.MigrationsInfrastructureLibRedTest+BloggingContext+Blog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
...
#pragma warning restore 612, 618
        ...
        {
            ((LibRedTestStore)Fixture.TestStore).ExecuteScript(value);
...
#pragma warning restore 612, 618
        ...
        public class MigrationsInfrastructureLibRedFixture : MigrationsInfrastructureFixtureBase
        {
            ...
            public override async Task InitializeAsync()
            {
                ...
                await ((LibRedTestStore)TestStore).ExecuteNonQueryAsync(
            ...
            public override MigrationsContext CreateContext()
            {
                var options = AddOptions(TestStore.AddProviderOptions(new DbContextOptionsBuilder()))
                    .UseLibRed(TestStore.ConnectionString, b => b.ApplyConfiguration())
...
namespace ModelSnapshot22
{
    ...
    public class BloggingContext : DbContext
    {
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
            => optionsBuilder.UseLibRed(@"Server=(localdb)\mssqllocaldb;Database=Test;ConnectRetryCount=0", TestEnvironment.DataAccessProviderFactory);
