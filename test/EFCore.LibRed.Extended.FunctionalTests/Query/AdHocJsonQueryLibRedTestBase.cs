...
public abstract class AdHocJsonQueryLibRedTestBase(NonSharedFixture fixture) : AdHocJsonQueryRelationalTestBase(fixture)
{
...
""");
    ...
    public virtual async Task Read_json_entity_with_enum_properties_with_legacy_values(bool async)
    {
        ...
        var testLogger = new TestLogger<LibRedLoggingDefinitions>();
        Assert.Single(
