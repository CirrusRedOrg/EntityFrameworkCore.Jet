...
#nullable disable
public class ManyToManyFieldsLoadLibRedTest : ManyToManyFieldsLoadTestBase<
    ManyToManyFieldsLoadLibRedTest.ManyToManyFieldsLoadLibRedFixture>
{
    public ManyToManyFieldsLoadLibRedTest(ManyToManyFieldsLoadLibRedFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
...
";
    ...
    public class ManyToManyFieldsLoadLibRedFixture : ManyToManyFieldsLoadFixtureBase, ITestSqlLoggerFactory
    {
