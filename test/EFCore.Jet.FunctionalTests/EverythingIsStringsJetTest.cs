...
AnimalIdentification.Method ---> [varchar] [MaxLength = -1]
...
BinaryKeyDataType.Ex ---> [nullable varchar] [MaxLength = -1]
BinaryKeyDataType.Id ---> [varchar] [MaxLength = 255]
BuiltInDataTypes.Enum16 ---> [varchar] [MaxLength = -1]
BuiltInDataTypes.Enum32 ---> [varchar] [MaxLength = -1]
BuiltInDataTypes.Enum64 ---> [varchar] [MaxLength = -1]
BuiltInDataTypes.Enum8 ---> [varchar] [MaxLength = -1]
BuiltInDataTypes.EnumS8 ---> [varchar] [MaxLength = -1]
BuiltInDataTypes.EnumU16 ---> [varchar] [MaxLength = -1]
BuiltInDataTypes.EnumU32 ---> [varchar] [MaxLength = -1]
BuiltInDataTypes.EnumU64 ---> [varchar] [MaxLength = -1]
...
BuiltInDataTypesShadow.Enum16 ---> [varchar] [MaxLength = -1]
BuiltInDataTypesShadow.Enum32 ---> [varchar] [MaxLength = -1]
BuiltInDataTypesShadow.Enum64 ---> [varchar] [MaxLength = -1]
BuiltInDataTypesShadow.Enum8 ---> [varchar] [MaxLength = -1]
BuiltInDataTypesShadow.EnumS8 ---> [varchar] [MaxLength = -1]
BuiltInDataTypesShadow.EnumU16 ---> [varchar] [MaxLength = -1]
BuiltInDataTypesShadow.EnumU32 ---> [varchar] [MaxLength = -1]
BuiltInDataTypesShadow.EnumU64 ---> [varchar] [MaxLength = -1]
...
BuiltInNullableDataTypes.Enum16 ---> [nullable varchar] [MaxLength = -1]
BuiltInNullableDataTypes.Enum32 ---> [nullable varchar] [MaxLength = -1]
BuiltInNullableDataTypes.Enum64 ---> [nullable varchar] [MaxLength = -1]
BuiltInNullableDataTypes.Enum8 ---> [nullable varchar] [MaxLength = -1]
BuiltInNullableDataTypes.EnumS8 ---> [nullable varchar] [MaxLength = -1]
BuiltInNullableDataTypes.EnumU16 ---> [nullable varchar] [MaxLength = -1]
BuiltInNullableDataTypes.EnumU32 ---> [nullable varchar] [MaxLength = -1]
BuiltInNullableDataTypes.EnumU64 ---> [nullable varchar] [MaxLength = -1]
BuiltInNullableDataTypes.Id ---> [varchar] [MaxLength = 64]
BuiltInNullableDataTypes.PartitionId ---> [varchar] [MaxLength = 64]
BuiltInNullableDataTypes.TestByteArray ---> [nullable varchar] [MaxLength = -1]
...
BuiltInNullableDataTypes.TestString ---> [nullable varchar] [MaxLength = -1]
BuiltInNullableDataTypesShadow.Enum16 ---> [nullable varchar] [MaxLength = -1]
BuiltInNullableDataTypesShadow.Enum32 ---> [nullable varchar] [MaxLength = -1]
BuiltInNullableDataTypesShadow.Enum64 ---> [nullable varchar] [MaxLength = -1]
BuiltInNullableDataTypesShadow.Enum8 ---> [nullable varchar] [MaxLength = -1]
BuiltInNullableDataTypesShadow.EnumS8 ---> [nullable varchar] [MaxLength = -1]
BuiltInNullableDataTypesShadow.EnumU16 ---> [nullable varchar] [MaxLength = -1]
BuiltInNullableDataTypesShadow.EnumU32 ---> [nullable varchar] [MaxLength = -1]
BuiltInNullableDataTypesShadow.EnumU64 ---> [nullable varchar] [MaxLength = -1]
BuiltInNullableDataTypesShadow.Id ---> [varchar] [MaxLength = 64]
BuiltInNullableDataTypesShadow.PartitionId ---> [varchar] [MaxLength = 64]
BuiltInNullableDataTypesShadow.TestByteArray ---> [nullable varchar] [MaxLength = -1]
...
BuiltInNullableDataTypesShadow.TestString ---> [nullable varchar] [MaxLength = -1]
EmailTemplate.Id ---> [varchar] [MaxLength = 36]
EmailTemplate.TemplateType ---> [varchar] [MaxLength = -1]
MaxLengthDataTypes.ByteArray5 ---> [nullable varchar] [MaxLength = 8]
MaxLengthDataTypes.ByteArray9000 ---> [nullable varchar] [MaxLength = -1]
MaxLengthDataTypes.Id ---> [varchar] [MaxLength = 64]
MaxLengthDataTypes.String3 ---> [nullable varchar] [MaxLength = 3]
MaxLengthDataTypes.String9000 ---> [nullable varchar] [MaxLength = -1]
...
UnicodeDataTypes.StringDefault ---> [nullable varchar] [MaxLength = -1]
UnicodeDataTypes.StringUnicode ---> [nullable varchar] [MaxLength = -1]
";
