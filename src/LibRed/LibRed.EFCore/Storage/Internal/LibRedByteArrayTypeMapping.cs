...
namespace EntityFrameworkCore.LibRed.Storage.Internal
{
    ...
    /// </summary>
    public class LibRedByteArrayTypeMapping : ByteArrayTypeMapping
    {
        public static new LibRedByteArrayTypeMapping Default { get; } = new();
        /// <summary>
        ///     This API supports the Entity Framework Core infrastructure and is not intended to be used
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        public LibRedByteArrayTypeMapping(
        ...
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        protected LibRedByteArrayTypeMapping(RelationalTypeMappingParameters parameters)
            : base(parameters)
        {
        }

        protected override RelationalTypeMapping Clone(RelationalTypeMappingParameters parameters)
            => new LibRedByteArrayTypeMapping(parameters);
