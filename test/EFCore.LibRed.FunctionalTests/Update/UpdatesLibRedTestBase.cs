...
public abstract class UpdatesLibRedTestBase<TFixture> : UpdatesRelationalTestBase<TFixture>
    where TFixture : UpdatesLibRedTestBase<TFixture>.UpdatesLibRedFixtureBase
{
    protected UpdatesLibRedTestBase(TFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
...
""");
    ...
    public abstract class UpdatesLibRedFixtureBase : UpdatesRelationalFixture
    {
