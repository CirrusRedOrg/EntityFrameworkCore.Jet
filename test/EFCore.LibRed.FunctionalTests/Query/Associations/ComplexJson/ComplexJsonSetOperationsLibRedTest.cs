...
public class ComplexJsonSetOperationsLibRedTest(ComplexJsonLibRedFixture fixture, ITestOutputHelper testOutputHelper)
    : ComplexJsonSetOperationsRelationalTestBase<ComplexJsonLibRedFixture>(fixture, testOutputHelper)
{
