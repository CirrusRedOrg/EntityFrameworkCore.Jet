...
{
    public class LibRedEndToEndTest : IClassFixture<LibRedFixture>
    {
        private const string DatabaseName = "LibRedEndToEndTest";

        protected LibRedFixture Fixture { get; }

        public LibRedEndToEndTest(LibRedFixture fixture)
        {
            Fixture = fixture;
        ...
        {
            await using var testDatabase = await LibRedTestStore.CreateInitializedAsync(DatabaseName);
        ...
        {
            await using var testStore = await LibRedTestStore.GetNorthwindStoreAsync();
        ...
        [ConditionalFact(Skip = "LibRed does not support Schema")] // Issue #931
