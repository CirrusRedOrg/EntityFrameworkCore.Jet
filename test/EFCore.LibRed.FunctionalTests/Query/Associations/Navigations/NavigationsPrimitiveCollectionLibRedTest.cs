...
public class NavigationsPrimitiveCollectionLibRedTest(NavigationsLibRedFixture fixture, ITestOutputHelper testOutputHelper)
    : NavigationsPrimitiveCollectionRelationalTestBase<NavigationsLibRedFixture>(fixture, testOutputHelper)
{
