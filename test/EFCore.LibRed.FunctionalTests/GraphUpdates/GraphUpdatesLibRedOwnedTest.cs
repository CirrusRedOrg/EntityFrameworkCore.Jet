...
public class GraphUpdatesLibRedOwnedTest(GraphUpdatesLibRedOwnedTest.LibRedFixture fixture)
    : GraphUpdatesLibRedTestBase<GraphUpdatesLibRedOwnedTest.LibRedFixture>(fixture)
{
    // No owned types
