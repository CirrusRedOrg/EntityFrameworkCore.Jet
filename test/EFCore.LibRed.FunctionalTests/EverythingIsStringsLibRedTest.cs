...
{
    public class EverythingIsStringsLibRedTest(EverythingIsStringsLibRedTest.EverythingIsStringsLibRedFixture fixture)
        : BuiltInDataTypesTestBase<
            EverythingIsStringsLibRedTest.EverythingIsStringsLibRedFixture>(fixture)
    {
        [ConditionalFact]
        ...
        public class EverythingIsStringsLibRedFixture : BuiltInDataTypesFixtureBase
        {
            ...
            protected override ITestStoreFactory TestStoreFactory => LibRedStringsTestStoreFactory.Instance;
        ...
        public class LibRedStringsTestStoreFactory : LibRedTestStoreFactory
        {
            public static new LibRedStringsTestStoreFactory Instance { get; } = new();

            public override IServiceCollection AddProviderServices(IServiceCollection serviceCollection)
                => base.AddProviderServices(
                    serviceCollection.AddSingleton<IRelationalTypeMappingSource, LibRedStringsTypeMappingSource>());
        }
        ...
        public class LibRedStringsTypeMappingSource : RelationalTypeMappingSource
        {
            ...
            public LibRedStringsTypeMappingSource(
            ...
            private RelationalTypeMapping FindRawMapping(RelationalTypeMappingInfo mappingInfo)
            {
                ...
                //Note - 255 is the max short text length in LibRed
