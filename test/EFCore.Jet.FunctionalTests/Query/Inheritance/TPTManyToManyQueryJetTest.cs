...
public class TPTManyToManyQueryJetTest : TPTManyToManyQueryRelationalTestBase<TPTManyToManyQueryJetFixture>
{
    public TPTManyToManyQueryJetTest(TPTManyToManyQueryJetFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
