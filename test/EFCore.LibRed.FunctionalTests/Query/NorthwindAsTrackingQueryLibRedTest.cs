...
{
    public class NorthwindAsTrackingQueryLibRedTest : NorthwindAsTrackingQueryTestBase<NorthwindQueryLibRedFixture<NoopModelCustomizer>>
    {
        public NorthwindAsTrackingQueryLibRedTest(NorthwindQueryLibRedFixture<NoopModelCustomizer> fixture)
            : base(fixture)
        {
