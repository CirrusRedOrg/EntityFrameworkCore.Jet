...
public class DateOnlyTranslationsJetTest : DateOnlyTranslationsTestBase<BasicTypesQueryJetFixture>
{
    public DateOnlyTranslationsJetTest(BasicTypesQueryJetFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
