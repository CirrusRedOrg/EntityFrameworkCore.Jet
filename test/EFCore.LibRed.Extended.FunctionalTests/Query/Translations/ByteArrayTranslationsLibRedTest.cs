...
public class ByteArrayTranslationsLibRedTest : ByteArrayTranslationsTestBase<BasicTypesQueryLibRedFixture>
{
    public ByteArrayTranslationsLibRedTest(BasicTypesQueryLibRedFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
