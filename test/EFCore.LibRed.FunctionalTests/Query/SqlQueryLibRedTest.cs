...
public class SqlQueryLibRedTest : SqlQueryTestBase<NorthwindQueryLibRedFixture<NoopModelCustomizer>>
{
    public SqlQueryLibRedTest(NorthwindQueryLibRedFixture<NoopModelCustomizer> fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
