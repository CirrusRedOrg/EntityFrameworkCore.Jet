...
{
    public class NorthwindNavigationsQueryLibRedTest : NorthwindNavigationsQueryRelationalTestBase<NorthwindQueryLibRedFixture<NoopModelCustomizer>>
    {
        public NorthwindNavigationsQueryLibRedTest(
