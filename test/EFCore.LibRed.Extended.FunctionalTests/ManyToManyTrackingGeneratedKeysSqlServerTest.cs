...
public class ManyToManyTrackingGeneratedKeysLibRedTest(
    ManyToManyTrackingGeneratedKeysLibRedTest.ManyToManyTrackingGeneratedKeysLibRedFixture fixture)
    : ManyToManyTrackingLibRedTestBase<ManyToManyTrackingGeneratedKeysLibRedTest.ManyToManyTrackingGeneratedKeysLibRedFixture>(
        fixture)
{
    public class ManyToManyTrackingGeneratedKeysLibRedFixture : ManyToManyTrackingLibRedFixtureBase
    {
