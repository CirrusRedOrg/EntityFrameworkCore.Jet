...
public class OwnedTableSplittingMiscellaneousJetTest(
    OwnedTableSplittingJetFixture fixture,
    ITestOutputHelper testOutputHelper)
    : OwnedTableSplittingMiscellaneousRelationalTestBase<OwnedTableSplittingJetFixture>(fixture, testOutputHelper)
{
