...
{
    public class NorthwindQueryTaggingQueryLibRedTest : NorthwindQueryTaggingQueryTestBase<NorthwindQueryLibRedFixture<NoopModelCustomizer>>
    {
        public NorthwindQueryTaggingQueryLibRedTest(
