...
{
    public class OptimisticConcurrencyULongLibRedTest(F1ULongLibRedFixture fixture)
        : OptimisticConcurrencyLibRedTestBase<F1ULongLibRedFixture, ulong>(fixture);
    ...
    public abstract class OptimisticConcurrencyLibRedTestBase<TFixture, TRowVersion>(TFixture fixture)
