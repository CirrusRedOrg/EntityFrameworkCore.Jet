...
{
    public class NorthwindAsNoTrackingQueryLibRedTest : NorthwindAsNoTrackingQueryTestBase<NorthwindQueryLibRedFixture<NoopModelCustomizer>>
    {
        public NorthwindAsNoTrackingQueryLibRedTest(
