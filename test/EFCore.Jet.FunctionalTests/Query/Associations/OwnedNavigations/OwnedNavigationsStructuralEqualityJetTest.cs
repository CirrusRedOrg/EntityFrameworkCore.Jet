...
public class OwnedNavigationsStructuralEqualityJetTest(
    OwnedNavigationsJetFixture fixture,
    ITestOutputHelper testOutputHelper)
    : OwnedNavigationsStructuralEqualityRelationalTestBase<OwnedNavigationsJetFixture>(fixture, testOutputHelper)
{
