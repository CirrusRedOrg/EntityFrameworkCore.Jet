...
public class OwnedNavigationsStructuralEqualityLibRedTest(
    OwnedNavigationsLibRedFixture fixture,
    ITestOutputHelper testOutputHelper)
    : OwnedNavigationsStructuralEqualityRelationalTestBase<OwnedNavigationsLibRedFixture>(fixture, testOutputHelper)
{
