...
#nullable disable
public abstract class SaveChangesInterceptionLibRedTestBase(
    ...
    : SaveChangesInterceptionTestBase(fixture)
{
    ...
    public class SaveChangesInterceptionLibRedTest(SaveChangesInterceptionLibRedTest.InterceptionLibRedFixture fixture)
        : SaveChangesInterceptionLibRedTestBase(fixture),
            IClassFixture<SaveChangesInterceptionLibRedTest.InterceptionLibRedFixture>
    {
    ...
    public class SaveChangesInterceptionWithDiagnosticsLibRedTest(
        SaveChangesInterceptionWithDiagnosticsLibRedTest.InterceptionLibRedFixture fixture)
        : SaveChangesInterceptionLibRedTestBase(fixture),
            IClassFixture<SaveChangesInterceptionWithDiagnosticsLibRedTest.InterceptionLibRedFixture>
    {
        public class InterceptionLibRedFixture : InterceptionLibRedFixtureBase
        {
            protected override string StoreName
