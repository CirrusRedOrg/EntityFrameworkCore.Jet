...
public abstract class StoreGeneratedLibRedTestBase<TFixture>(TFixture fixture) : StoreGeneratedTestBase<TFixture>(fixture)
    where TFixture : StoreGeneratedLibRedTestBase<TFixture>.StoreGeneratedLibRedFixtureBase, new()
{
    ...
    public abstract class StoreGeneratedLibRedFixtureBase : StoreGeneratedFixtureBase
    {
