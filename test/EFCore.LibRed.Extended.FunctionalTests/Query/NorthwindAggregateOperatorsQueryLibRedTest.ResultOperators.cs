...
{
    public class NorthwindAggregateOperatorsQueryLibRedTest : NorthwindAggregateOperatorsQueryRelationalTestBase<
        NorthwindQueryLibRedFixture<NoopModelCustomizer>>
    {
        public NorthwindAggregateOperatorsQueryLibRedTest(
...
""");
        ...
        public override async Task MinBy(bool async)
        {
