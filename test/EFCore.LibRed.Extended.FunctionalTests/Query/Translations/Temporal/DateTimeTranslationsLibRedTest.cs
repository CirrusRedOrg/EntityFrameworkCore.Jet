...
public class DateTimeTranslationsLibRedTest : DateTimeTranslationsTestBase<BasicTypesQueryLibRedFixture>
{
    public DateTimeTranslationsLibRedTest(BasicTypesQueryLibRedFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
