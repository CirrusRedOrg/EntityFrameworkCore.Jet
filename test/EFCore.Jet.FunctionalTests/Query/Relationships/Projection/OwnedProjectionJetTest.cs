...
public class OwnedProjectionJetTest
    : OwnedProjectionRelationalTestBase<OwnedRelationshipsJetFixture>
{
    public OwnedProjectionJetTest(OwnedRelationshipsJetFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
