...
public class ComplexTypeQueryLibRedTest : ComplexTypeQueryRelationalTestBase<
    ComplexTypeQueryLibRedTest.ComplexTypeQueryLibRedFixture>
{
    public ComplexTypeQueryLibRedTest(ComplexTypeQueryLibRedFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
...
""");
    ...
    public override async Task Complex_type_equals_parameter(bool async)
    {
        ...
        AssertSql(
            """
@entity_equality_address_AddressLine1='804 S. Lakeshore Road' (Size = 255)
@entity_equality_address_Tags='["foo","bar"]' (Size = 255)
@entity_equality_address_ZipCode='38654' (Nullable = true)
@entity_equality_address_Country_Code='US' (Size = 255)
@entity_equality_address_Country_FullName='United States' (Size = 255)
...
FROM `TpcChild1` AS `t`
UNION ALL
SELECT `t0`.`Id`, CVar(NULL) AS `ChildProperty`, `t0`.`ChildProperty` AS `ChildProperty1`, `t0`.`PropertyInsideComplexThing`, CVar(NULL) AS `ChildComplexProperty_PropertyInsideComplexThing`, `t0`.`ChildComplexProperty_PropertyInsideComplexThing` AS `ChildComplexProperty_PropertyInsideComplexThing1`, 'TpcChild2' AS `Discriminator`
...
SELECT COUNT(*)
FROM `EntityType` AS `e`
WHERE `e`.`ComplexThing_DateTime` = #2020-01-01 01:01:01.999#
""");
    }
...
""",
            ...
            """
@p2='3'
@p0='AllOptionalsComplexType' (Size = 255)
@p1='New thing' (Size = 255)
...
""",
            ...
            """
@p1='1'
@p0='98102' (Nullable = false) (Size = 255)
...
""",
            ...
            """
@p1='1'
@p0='98103' (Nullable = false) (Size = 255)
...
""",
            ...
            """
@p1='2'
@p0='98054' (Nullable = false) (Size = 255)
...
""");
    ...
    public class ComplexTypeQueryLibRedFixture : ComplexTypeQueryRelationalFixtureBase
    {
