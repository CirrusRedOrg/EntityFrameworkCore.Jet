...
{
    public class OwnedQueryLibRedTest : OwnedQueryRelationalTestBase<OwnedQueryLibRedTest.OwnedQueryLibRedFixture>
    {
        public OwnedQueryLibRedTest(OwnedQueryLibRedFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
...
""");
        ...
        public class OwnedQueryLibRedFixture : RelationalOwnedQueryFixture
        {
