...
public class OwnedJsonProjectionJetTest
    : OwnedJsonProjectionRelationalTestBase<OwnedJsonRelationshipsJetFixture>
{
    public OwnedJsonProjectionJetTest(OwnedJsonRelationshipsJetFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
