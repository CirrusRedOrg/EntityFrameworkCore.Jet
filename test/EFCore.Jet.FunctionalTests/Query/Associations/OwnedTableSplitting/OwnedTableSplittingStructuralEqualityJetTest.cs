...
public class OwnedTableSplittingStructuralEqualityJetTest(
    OwnedTableSplittingJetFixture fixture,
    ITestOutputHelper testOutputHelper)
    : OwnedTableSplittingStructuralEqualityRelationalTestBase<OwnedTableSplittingJetFixture>(fixture, testOutputHelper)
{
