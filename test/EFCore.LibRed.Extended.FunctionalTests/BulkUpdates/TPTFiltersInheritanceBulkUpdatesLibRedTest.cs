...
public class TPTFiltersInheritanceBulkUpdatesLibRedTest(
    TPTFiltersInheritanceBulkUpdatesLibRedFixture fixture,
    ITestOutputHelper testOutputHelper)
    : TPTFiltersInheritanceBulkUpdatesTestBase<
        TPTFiltersInheritanceBulkUpdatesLibRedFixture>(fixture, testOutputHelper)
{
    [Fact]
