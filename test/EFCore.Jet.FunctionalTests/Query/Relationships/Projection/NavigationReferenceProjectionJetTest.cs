...
public class NavigationReferenceProjectionJetTest
    : NavigationReferenceProjectionRelationalTestBase<NavigationRelationshipsJetFixture>
{
    public NavigationReferenceProjectionJetTest(NavigationRelationshipsJetFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
