...
{
    public class DataAnnotationLibRedTest : DataAnnotationRelationalTestBase<DataAnnotationLibRedTest.DataAnnotationLibRedFixture>
    {
        // ReSharper disable once UnusedParameter.Local
        public DataAnnotationLibRedTest(DataAnnotationLibRedFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
        ...
        public class DataAnnotationLibRedFixture : DataAnnotationRelationalFixtureBase
        {
