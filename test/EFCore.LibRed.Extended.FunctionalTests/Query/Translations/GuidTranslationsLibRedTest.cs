...
public class GuidTranslationsLibRedTest : GuidTranslationsTestBase<BasicTypesQueryLibRedFixture>
{
    public GuidTranslationsLibRedTest(BasicTypesQueryLibRedFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
