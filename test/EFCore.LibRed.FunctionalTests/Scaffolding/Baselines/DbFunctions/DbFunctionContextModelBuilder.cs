    ...
    public partial class DbFunctionContextModel
    {
        ...
        partial void Initialize()
        {
            ...
            var id = getCount.AddParameter(
                ...
                true,
                "uniqueidentifier");
            id.TypeMapping = JetGuidTypeMapping.Default.Clone(
            ...
            getCount.TypeMapping = JetIntTypeMapping.Default.Clone(
            ...
            var id0 = getData0.AddParameter(
                ...
                false,
                "integer");
            id0.TypeMapping = JetIntTypeMapping.Default.Clone(
                comparer: new ValueComparer<int>(
                    bool (int v1, int v2) => v1 == v2,
                    int (int v) => v,
                    int (int v) => v),
            ...
            isDateStatic.TypeMapping = JetBoolTypeMapping.Default.Clone(
        ...
        private IRelationalModel CreateRelationalModel()
        {
            ...
            var blobColumnBase = new ColumnBase<ColumnMappingBase>("Blob", "longbinary", microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBaseDataTableBase)
            {
                IsNullable = true
            };
            ...
            var blobFunctionColumn = new FunctionColumn("Blob", "longbinary", getAllDataFunction)
            {
                IsNullable = true
            };
            ...
            var blobFunctionColumn0 = new FunctionColumn("Blob", "longbinary", getDataFunction)
            {
                IsNullable = true
            };
            ...
            relationalModel.Functions.Add(
                ("CustomerOrderCount", "dbf", new[] { "uniqueidentifier", "char(256)" }),
