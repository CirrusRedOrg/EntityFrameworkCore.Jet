...
public class NorthwindStringIncludeQueryLibRedTest : NorthwindStringIncludeQueryTestBase<
    NorthwindQueryLibRedFixture<NoopModelCustomizer>>
{
    // ReSharper disable once UnusedParameter.Local
    public NorthwindStringIncludeQueryLibRedTest(NorthwindQueryLibRedFixture<NoopModelCustomizer> fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
