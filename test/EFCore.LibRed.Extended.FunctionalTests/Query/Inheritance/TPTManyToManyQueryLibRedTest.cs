...
public class TPTManyToManyQueryLibRedTest : TPTManyToManyQueryRelationalTestBase<TPTManyToManyQueryLibRedFixture>
{
    public TPTManyToManyQueryLibRedTest(TPTManyToManyQueryLibRedFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
...
ORDER BY (
    ...
    WHERE `e`.`Id` = `j`.`EntityOneId` AND (`s`.`Name` LIKE 'L%')), `e`.`Id`
""");
    }
...
ORDER BY `e`.`Key1`, `e`.`Key2`, `e`.`Key3`, `s0`.`LeafId`, `s0`.`CompositeId1`, `s0`.`CompositeId2`
""");
    }
...
LEFT JOIN (
    ...
    WHERE `s`.`Discriminator` = 'EntityLeaf'
...
ORDER BY `e`.`Key1`, `e`.`Key2`, `e`.`Key3`, `s0`.`RootSkipSharedId`, `s0`.`CompositeKeySkipSharedKey1`, `s0`.`CompositeKeySkipSharedKey2`
""");
    }
...
INNER JOIN (
    ...
    WHERE `s`.`Discriminator` IN ('EntityBranch', 'EntityLeaf')
) AS `s0` ON `e`.`Id` = `s0`.`ThreeSkipSharedId`
""");
    }
...
ORDER BY `e`.`Key1`, `e`.`Key2`, `e`.`Key3`, `s1`.`LeafId`, `s1`.`CompositeId1`, `s1`.`CompositeId2`, `s1`.`CompositeId3`, `s1`.`EntityBranchId`, `s1`.`EntityOneId`
""");
    }
...
ORDER BY `r`.`Id`, `s0`.`RootSkipSharedId`, `s0`.`ThreeSkipSharedId`, `s0`.`OneId`
""");
    }
...
ORDER BY `r`.`Id`, `s1`.`RootSkipSharedId`, `s1`.`CompositeKeySkipSharedKey1`, `s1`.`CompositeKeySkipSharedKey2`, `s1`.`CompositeKeySkipSharedKey3`, `s1`.`CompositeId1`, `s1`.`CompositeId2`, `s1`.`CompositeId3`, `s1`.`Id0`
""");
    }
...
ORDER BY `r`.`Id`, `s0`.`LeafId`, `s0`.`CompositeId1`, `s0`.`CompositeId2`, `s0`.`CompositeId3`, `s0`.`TwoSkipSharedId`, `s0`.`CompositeKeySkipSharedKey1`, `s0`.`CompositeKeySkipSharedKey2`
""");
    }
...
ORDER BY `e`.`Id`, `s3`.`OneId`, `s3`.`ThreeId`, `s3`.`OneId0`, `s3`.`Id0`, `s3`.`TwoId`, `s3`.`EntityBranchId`
""");
    }
...
""",
            //
            """
SELECT `s1`.`EntityBranchId`, `s1`.`EntityOneId`, `s1`.`Id`, `s1`.`Name`, `e`.`Key1`, `e`.`Key2`, `e`.`Key3`, `s0`.`LeafId`, `s0`.`CompositeId1`, `s0`.`CompositeId2`, `s0`.`CompositeId3`
FROM `EntityCompositeKeys` AS `e`
INNER JOIN (
...
ORDER BY `r`.`Id`, `s`.`RootSkipSharedId`, `s`.`ThreeSkipSharedId`
""",
            //
            """
SELECT `s0`.`OneId`, `s0`.`ThreeId`, `s0`.`Payload`, `s0`.`Id`, `s0`.`Name`, `r`.`Id`, `s`.`RootSkipSharedId`, `s`.`ThreeSkipSharedId`
FROM `Roots` AS `r`
INNER JOIN (
...
ORDER BY `r`.`Id`, `s`.`RootSkipSharedId`, `s`.`CompositeKeySkipSharedKey1`, `s`.`CompositeKeySkipSharedKey2`, `s`.`CompositeKeySkipSharedKey3`
""",
            //
            """
SELECT `s1`.`Id`, `s1`.`CompositeId1`, `s1`.`CompositeId2`, `s1`.`CompositeId3`, `s1`.`ThreeId`, `s1`.`Id0`, `s1`.`CollectionInverseId`, `s1`.`Name`, `s1`.`ReferenceInverseId`, `r`.`Id`, `s`.`RootSkipSharedId`, `s`.`CompositeKeySkipSharedKey1`, `s`.`CompositeKeySkipSharedKey2`, `s`.`CompositeKeySkipSharedKey3`
FROM `Roots` AS `r`
INNER JOIN (
...
ORDER BY `r`.`Id`, `s`.`RootSkipSharedId`, `s`.`CompositeKeySkipSharedKey1`, `s`.`CompositeKeySkipSharedKey2`, `s`.`CompositeKeySkipSharedKey3`, `s1`.`CompositeId1`, `s1`.`CompositeId2`, `s1`.`CompositeId3`, `s1`.`Id0`
""");
    }
...
ORDER BY `r`.`Id`, `s`.`LeafId`, `s`.`CompositeId1`, `s`.`CompositeId2`, `s`.`CompositeId3`
""",
            //
            """
SELECT `s0`.`TwoSkipSharedId`, `s0`.`CompositeKeySkipSharedKey1`, `s0`.`CompositeKeySkipSharedKey2`, `s0`.`CompositeKeySkipSharedKey3`, `s0`.`Id`, `s0`.`CollectionInverseId`, `s0`.`ExtraId`, `s0`.`Name`, `s0`.`ReferenceInverseId`, `r`.`Id`, `s`.`LeafId`, `s`.`CompositeId1`, `s`.`CompositeId2`, `s`.`CompositeId3`
FROM `Roots` AS `r`
INNER JOIN `Branches` AS `b` ON `r`.`Id` = `b`.`Id`
INNER JOIN `Leaves` AS `l` ON `r`.`Id` = `l`.`Id`
INNER JOIN (
...
ORDER BY `e`.`Id`, `s0`.`OneId`, `s0`.`ThreeId`
""",
            //
            """
SELECT `s2`.`OneId`, `s2`.`TwoId`, `s2`.`JoinOneToTwoExtraId`, `s2`.`Id`, `s2`.`CollectionInverseId`, `s2`.`ExtraId`, `s2`.`Name`, `s2`.`ReferenceInverseId`, `e`.`Id`, `s0`.`OneId`, `s0`.`ThreeId`
FROM `EntityThrees` AS `e`
INNER JOIN (
    SELECT `j`.`OneId`, `j`.`ThreeId`, `e0`.`Id`
    FROM `JoinOneToThreePayloadFull` AS `j`
...
ORDER BY `e`.`Id`, `s0`.`OneId`, `s0`.`ThreeId`, `s2`.`OneId`, `s2`.`Id`
""",
            //
            """
SELECT `s3`.`EntityBranchId`, `s3`.`EntityOneId`, `s3`.`Id`, `s3`.`Name`, `s3`.`Number`, `s3`.`IsGreen`, `s3`.`Discriminator`, `e`.`Id`, `s0`.`OneId`, `s0`.`ThreeId`
FROM `EntityThrees` AS `e`
INNER JOIN (
    SELECT `j`.`OneId`, `j`.`ThreeId`, `e0`.`Id`
    FROM `JoinOneToThreePayloadFull` AS `j`
...
ORDER BY `e`.`Id`, `s0`.`OneId`, `s0`.`ThreeId`, `s0`.`OneId0`, `s0`.`ThreeId0`
""");
    }
...
ORDER BY (
    ...
    WHERE `u`.`Id` = `u0`.`UnidirectionalEntityOneId` AND (`s`.`Name` LIKE 'L%')), `u`.`Id`
""");
    }
...
LEFT JOIN (
    ...
    WHERE `s`.`Discriminator` = 'UnidirectionalEntityLeaf'
...
ORDER BY `u`.`Key1`, `u`.`Key2`, `u`.`Key3`, `s0`.`RootSkipSharedId`, `s0`.`UnidirectionalEntityCompositeKeyKey1`, `s0`.`UnidirectionalEntityCompositeKeyKey2`
""");
    }
...
ORDER BY `u`.`Key1`, `u`.`Key2`, `u`.`Key3`, `s1`.`LeafId`, `s1`.`CompositeId1`, `s1`.`CompositeId2`, `s1`.`CompositeId3`, `s1`.`UnidirectionalEntityBranchId`, `s1`.`UnidirectionalEntityOneId`
""");
    }
...
ORDER BY `u`.`Id`, `s0`.`OneId`, `s0`.`ThreeId`, `s0`.`OneId0`, `s0`.`ThreeId0`
""");
    }
...
ORDER BY `u`.`Id`, `s0`.`UnidirectionalEntityTwoId`, `s0`.`Id`, `s0`.`SelfSkipSharedRightId`
""");
    }
...
ORDER BY `u`.`Key1`, `u`.`Key2`, `u`.`Key3`, `s0`.`UnidirectionalEntityCompositeKeyKey1`, `s0`.`UnidirectionalEntityCompositeKeyKey2`, `s0`.`UnidirectionalEntityCompositeKeyKey3`, `s0`.`Id`, `s0`.`TwoSkipSharedId`
""");
    }
