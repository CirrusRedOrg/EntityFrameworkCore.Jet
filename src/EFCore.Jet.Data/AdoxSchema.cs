...
namespace EntityFrameworkCore.Jet.Data
{
    public class AdoxSchema : SchemaProvider
    {
        ...
        public AdoxSchema(JetConnection connection, bool readOnly)
        {
            ...
            try
            {
                var connectionString = GetOleDbConnectionString(connection.ActiveConnectionString ?? throw new ArgumentNullException(nameof(connection.ActiveConnectionString)));
