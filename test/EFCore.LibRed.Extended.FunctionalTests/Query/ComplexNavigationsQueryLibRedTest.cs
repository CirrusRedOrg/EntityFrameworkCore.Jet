...
{
    public class ComplexNavigationsQueryLibRedTest : ComplexNavigationsQueryRelationalTestBase<ComplexNavigationsQueryLibRedFixture>
    {
        public ComplexNavigationsQueryLibRedTest(
            ComplexNavigationsQueryLibRedFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
...
FROM `LevelOne` AS `l`
LEFT JOIN `LevelTwo` AS `l0` ON `l`.`Id` = `l0`.`Level1_Optional_Id`
WHERE `l0`.`Name` IS NOT NULL AND LEFT(`l0`.`Name`, COALESCE(LEN(`l0`.`Name`), 0)) = `l0`.`Name`
""");
        }
...
FROM `LevelOne` AS `l`
LEFT JOIN `LevelTwo` AS `l0` ON `l`.`Id` = `l0`.`Level1_Optional_Id`
WHERE DATEADD('d', CDBL(COALESCE(`l0`.`Id`, 0)), DATEADD('d', 15.0, `l0`.`Date`)) > #2002-02-01#
""");
        }
...
""");
        ...
        public override async Task Optional_navigation_projected_into_DTO(bool isAsync)
        {
            ...
            AssertSql(
                """
SELECT `l`.`Id`, `l`.`Name`, `l0`.`Id` IS NOT NULL, `l0`.`Id`, `l0`.`Name`
FROM `LevelOne` AS `l`
LEFT JOIN `LevelTwo` AS `l0` ON `l`.`Id` = `l0`.`Level1_Optional_Id`
""");
        }
...
LEFT JOIN `LevelTwo` AS `l0` ON `s`.`Id` = `l0`.`Level1_Optional_Id`
ORDER BY `s`.`Id`
""");
        }
...
WHERE (
    SELECT COUNT(*)
    FROM `LevelOne` AS `l0`) > 7 AND `l`.`Id` < 3
""");
        }
...
WHERE (
    ...
    WHERE (
        SELECT COUNT(*)
        FROM `LevelOne` AS `l1`) > 7) > 4 AND `l`.`Id` < 2
""");
        }
        ...
        public override async Task GroupJoin_client_method_in_OrderBy(bool isAsync)
        {
            await AssertTranslationFailedWithDetails(
                ...
                CoreStrings.QueryUnableToTranslateMethod(
                    "Microsoft.EntityFrameworkCore.Query.ComplexNavigationsQueryTestBase<EntityFrameworkCore.LibRed.Extended.FunctionalTests.Query.ComplexNavigationsQueryLibRedFixture>",
...
""");
        ...
        public override async Task Select_optional_navigation_property_string_concat(bool isAsync)
        {
            ...
            AssertSql(
                """
SELECT (COALESCE(`l`.`Name`, '') & ' ') & COALESCE(CASE
...
""");
        ...
        public override async Task Accessing_optional_property_inside_result_operator_subquery(bool isAsync)
        {
            ...
            AssertSql(
                """
@names1='Name1' (Size = 255)
@names2='Name2' (Size = 255)
...
""");
        ...
        public override async Task Contains_over_optional_navigation_with_null_column(bool async)
        {
            ...
            AssertSql(
                """
SELECT `l`.`Name`, `l0`.`Name` AS `OptionalName`, EXISTS (
    SELECT 1
    FROM `LevelOne` AS `l1`
    LEFT JOIN `LevelTwo` AS `l2` ON `l1`.`Id` = `l2`.`Level1_Optional_Id`
    WHERE `l2`.`Name` = `l0`.`Name` OR (`l2`.`Name` IS NULL AND `l0`.`Name` IS NULL)) AS `Contains`
FROM `LevelOne` AS `l`
LEFT JOIN `LevelTwo` AS `l0` ON `l`.`Id` = `l0`.`Level1_Optional_Id`
""");
        }
...
SELECT `l`.`Name`, `l0`.`Name` AS `OptionalName`, EXISTS (
    ...
    WHERE `l3`.`Id` = `l1`.`Id` OR (`l3`.`Id` IS NULL AND `l1`.`Id` IS NULL)) AS `Contains`
FROM `LevelOne` AS `l`
LEFT JOIN `LevelTwo` AS `l0` ON `l`.`Id` = `l0`.`Level1_Optional_Id`
LEFT JOIN `LevelTwo` AS `l1` ON `l`.`Id` = `l1`.`OneToOne_Optional_PK_Inverse2Id`
""");
...
""");
        ...
        public override async Task Nested_object_constructed_from_group_key_properties(bool async)
        {
            ...
            AssertSql(
                """
SELECT `l`.`Id`, `l`.`Name`, `l`.`Date`, `l0`.`Id`, `l1`.`Name`, `l0`.`Date`, `l0`.`Level1_Optional_Id`, `l0`.`Level1_Required_Id`, COALESCE(SUM(LEN(`l`.`Name`)), 0) AS `Aggregate`
FROM `LevelOne` AS `l`
LEFT JOIN `LevelTwo` AS `l0` ON `l`.`Id` = `l0`.`Level1_Optional_Id`
LEFT JOIN `LevelTwo` AS `l1` ON `l`.`Id` = `l1`.`Level1_Required_Id`
WHERE `l0`.`Id` IS NOT NULL
...
""");
        ...
        public override async Task Member_over_null_check_ternary_and_nested_dto_type(bool async)
        {
            ...
            AssertSql(
                """
SELECT `l`.`Id`, `l`.`Name`, `l0`.`Id` IS NULL, `l0`.`Id`, `l0`.`Name`
FROM `LevelOne` AS `l`
LEFT JOIN `LevelTwo` AS `l0` ON `l`.`Id` = `l0`.`Level1_Optional_Id`
ORDER BY `l0`.`Name`, `l`.`Id`
""");
        ...
        public override async Task Member_over_null_check_ternary_and_nested_anonymous_type(bool async)
        {
            ...
            AssertSql(
                """
SELECT `l`.`Id`, `l`.`Name`, `l0`.`Id` IS NULL, `l0`.`Id`, `l0`.`Name`, `l1`.`Id` IS NULL, `l1`.`Id`, `l1`.`Name`
FROM `LevelOne` AS `l`
LEFT JOIN `LevelTwo` AS `l0` ON `l`.`Id` = `l0`.`Level1_Optional_Id`
LEFT JOIN `LevelThree` AS `l1` ON `l0`.`Id` = `l1`.`Level2_Optional_Id`
WHERE CASE
...
""");
        ...
        public override async Task Multiple_conditionals_in_projection(bool async)
        {
            ...
            AssertSql(
                """
SELECT `l`.`Id`, `l0`.`Name`, `l1`.`Id` IS NULL
FROM `LevelTwo` AS `l`
...
LEFT JOIN (
    ...
    FROM (
        SELECT `l1`.`Id`, `l1`.`Level2_Optional_Id`, `l1`.`Level2_Required_Id`, `l1`.`Name`, `l1`.`OneToMany_Optional_Inverse3Id`, `l1`.`OneToMany_Optional_Self_Inverse3Id`, `l1`.`OneToMany_Required_Inverse3Id`, `l1`.`OneToMany_Required_Self_Inverse3Id`, `l1`.`OneToOne_Optional_PK_Inverse3Id`, `l1`.`OneToOne_Optional_Self3Id`, `l0`.`OneToMany_Optional_Inverse2Id`, ROW_NUMBER() OVER(PARTITION BY `l0`.`OneToMany_Optional_Inverse2Id` ORDER BY `l0`.`Id`) AS `row`
        FROM `LevelTwo` AS `l0`
        LEFT JOIN `LevelThree` AS `l1` ON `l0`.`Id` = `l1`.`Level2_Optional_Id`
        WHERE `l0`.`Name` = 'L2 02'
    ) AS `s`
...
""");
        ...
        public override async Task Collection_FirstOrDefault_entity_collection_accesses_in_projection(bool async)
        {
            ...
            AssertSql(
                """
SELECT `l`.`Id`, `l1`.`Id`, `l1`.`Level2_Optional_Id`, `l1`.`Level2_Required_Id`, `l1`.`Name`, `l1`.`OneToMany_Optional_Inverse3Id`, `l1`.`OneToMany_Optional_Self_Inverse3Id`, `l1`.`OneToMany_Required_Inverse3Id`, `l1`.`OneToMany_Required_Self_Inverse3Id`, `l1`.`OneToOne_Optional_PK_Inverse3Id`, `l1`.`OneToOne_Optional_Self3Id`, `l3`.`c`
FROM `LevelOne` AS `l`
LEFT JOIN (
...
LEFT JOIN (
    SELECT `l0`.`Id`, `l1`.`Id` AS `Id0`, `l2`.`Id` AS `Id1`, COALESCE((
        SELECT MAX(`l3`.`Id`)
        FROM `LevelFour` AS `l3`
        WHERE `l1`.`Id` IS NOT NULL AND `l1`.`Id` = `l3`.`OneToMany_Optional_Inverse4Id`), 0) > 1 AS `Result`, `l0`.`OneToMany_Optional_Inverse2Id`
    FROM `LevelTwo` AS `l0`
    LEFT JOIN `LevelThree` AS `l1` ON `l0`.`Id` = `l1`.`Level2_Required_Id`
    LEFT JOIN `LevelFour` AS `l2` ON `l1`.`Id` = `l2`.`Level3_Required_Id`
...
SELECT `l`.`Id`, `s0`.`Id`, `s0`.`RefId`, `s0`.`Id0`, (
    ...
    WHERE `l`.`Id` = `l3`.`OneToMany_Optional_Inverse2Id` AND (`l4`.`Name` <> '' OR `l4`.`Name` IS NULL))
FROM `LevelOne` AS `l`
OUTER APPLY (
