...
public class ComplexCollectionJsonUpdateLibRedTest : ComplexCollectionJsonUpdateTestBase<
    ComplexCollectionJsonUpdateLibRedTest.ComplexCollectionJsonUpdateLibRedFixture>
{
    public ComplexCollectionJsonUpdateLibRedTest(ComplexCollectionJsonUpdateLibRedFixture fixture)
        : base(fixture)
        => ClearLog();
...
""");
    ...
    public class ComplexCollectionJsonUpdateLibRedFixture : ComplexCollectionJsonUpdateFixtureBase
    {
