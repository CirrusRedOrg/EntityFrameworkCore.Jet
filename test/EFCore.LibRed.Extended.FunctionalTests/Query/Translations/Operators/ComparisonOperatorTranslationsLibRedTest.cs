...
public class ComparisonOperatorTranslationsLibRedTest : ComparisonOperatorTranslationsTestBase<BasicTypesQueryLibRedFixture>
{
    public ComparisonOperatorTranslationsLibRedTest(BasicTypesQueryLibRedFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
