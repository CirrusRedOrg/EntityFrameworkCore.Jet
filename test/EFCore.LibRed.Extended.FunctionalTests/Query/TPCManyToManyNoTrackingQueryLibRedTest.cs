...
public class TPCManyToManyNoTrackingQueryLibRedTest : TPCManyToManyNoTrackingQueryRelationalTestBase<TPCManyToManyQueryLibRedFixture>
{
    public TPCManyToManyNoTrackingQueryLibRedTest(TPCManyToManyQueryLibRedFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
