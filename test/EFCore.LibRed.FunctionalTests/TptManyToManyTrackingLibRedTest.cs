...
public class TptManyToManyTrackingLibRedTest(TptManyToManyTrackingLibRedTest.TptManyToManyTrackingLibRedFixture fixture)
    : ManyToManyTrackingLibRedTestBase<TptManyToManyTrackingLibRedTest.TptManyToManyTrackingLibRedFixture>(fixture)
{
    public class TptManyToManyTrackingLibRedFixture : ManyToManyTrackingLibRedFixtureBase
    {
        protected override string StoreName
            => "TptManyToManyTrackingLibRedTest";
