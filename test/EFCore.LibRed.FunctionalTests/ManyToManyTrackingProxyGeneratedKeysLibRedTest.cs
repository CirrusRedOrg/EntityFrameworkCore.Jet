...
public class ManyToManyTrackingProxyGeneratedKeysLibRedTest(
    ManyToManyTrackingProxyGeneratedKeysLibRedTest.ManyToManyTrackingProxyGeneratedKeysLibRedFixture fixture)
    : ManyToManyTrackingLibRedTestBase<
        ManyToManyTrackingProxyGeneratedKeysLibRedTest.ManyToManyTrackingProxyGeneratedKeysLibRedFixture>(fixture)
{
    ...
    public class ManyToManyTrackingProxyGeneratedKeysLibRedFixture : ManyToManyTrackingLibRedFixtureBase
    {
