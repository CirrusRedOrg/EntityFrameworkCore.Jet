...
public class ComplexJsonStructuralEqualityLibRedTest(ComplexJsonLibRedFixture fixture, ITestOutputHelper testOutputHelper)
    : ComplexJsonStructuralEqualityRelationalTestBase<ComplexJsonLibRedFixture>(fixture, testOutputHelper)
{
