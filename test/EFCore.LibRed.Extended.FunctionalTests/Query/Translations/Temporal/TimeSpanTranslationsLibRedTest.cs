...
public class TimeSpanTranslationsLibRedTest : TimeSpanTranslationsTestBase<BasicTypesQueryLibRedFixture>
{
    public TimeSpanTranslationsLibRedTest(BasicTypesQueryLibRedFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
