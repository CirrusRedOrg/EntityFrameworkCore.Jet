...
public class OwnedTableSplittingPrimitiveCollectionLibRedTest(
    OwnedTableSplittingLibRedFixture fixture,
    ITestOutputHelper testOutputHelper)
    : OwnedTableSplittingPrimitiveCollectionRelationalTestBase<OwnedTableSplittingLibRedFixture>(fixture, testOutputHelper)
{
