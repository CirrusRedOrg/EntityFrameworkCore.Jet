...
public class TPCManyToManyQueryLibRedTest : TPCManyToManyQueryRelationalTestBase<TPCManyToManyQueryLibRedFixture>
{
    public TPCManyToManyQueryLibRedTest(TPCManyToManyQueryLibRedFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
