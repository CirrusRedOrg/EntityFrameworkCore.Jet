...
namespace TestNamespace
{
    ...
    public partial class OwnedTypeEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            ...
            principalBaseId.TypeMapping = JetIntTypeMapping.Default.Clone(
                ...
                providerValueComparer: new ValueComparer<int>(
                    ...
                    int (int v) => v,
                    int (int v) => v),
                converter: new ValueConverter<long, int>(
                    int (long v) => ((int)v),
                    long (int v) => ((long)v)),
                jsonValueReaderWriter: new JsonConvertedValueReaderWriter<long, int>(
                    JsonInt32ReaderWriter.Instance,
                    new ValueConverter<long, int>(
                        int (long v) => ((int)v),
                        long (int v) => ((long)v))));
            principalBaseId.SetCurrentValueComparer(new EntryCurrentValueComparer<long>(principalBaseId));
            principalBaseId.SetSentinelFromProviderValue(0);
            ...
            var principalBaseIdPrincipalBase = new RuntimeRelationalPropertyOverrides(
                ...
                false,
                null);
            principalBaseIdPrincipalBase.AddAnnotation("Jet:IdentityIncrement", 3);
            principalBaseIdPrincipalBase.AddAnnotation("Jet:IdentitySeed", 2);
            principalBaseIdPrincipalBase.AddAnnotation("Jet:ValueGenerationStrategy", JetValueGenerationStrategy.IdentityColumn);
            ...
            principalBaseId.AddAnnotation("Jet:ValueGenerationStrategy", JetValueGenerationStrategy.IdentityColumn);
            ...
            principalBaseAlternateId.TypeMapping = JetGuidTypeMapping.Default.Clone(
