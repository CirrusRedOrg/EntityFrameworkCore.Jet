...
{
    public class QueryLoggingLibRedTest : IClassFixture<NorthwindQueryLibRedFixture<NoopModelCustomizer>>
    {
        private static readonly string _eol = Environment.NewLine;

        public QueryLoggingLibRedTest(NorthwindQueryLibRedFixture<NoopModelCustomizer> fixture)
        {
            Fixture = fixture;
            Fixture.TestSqlLoggerFactory.Clear();
        }

        protected NorthwindQueryLibRedFixture<NoopModelCustomizer> Fixture { get; }
        ...
        public void SelectExpression_does_not_use_an_old_logger()
        {
            ...
            using (var context = new NorthwindLibRedContext(CreateOptions(loggerFactory1)))
            {
            ...
            using (var context = new NorthwindLibRedContext(CreateOptions(loggerFactory2)))
            {
                var _ = context.Customers.ToList();
            }
