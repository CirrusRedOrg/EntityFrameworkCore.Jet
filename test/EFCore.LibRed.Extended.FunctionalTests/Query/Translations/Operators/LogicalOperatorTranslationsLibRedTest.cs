...
public class LogicalOperatorTranslationsLibRedTest : LogicalOperatorTranslationsTestBase<BasicTypesQueryLibRedFixture>
{
    public LogicalOperatorTranslationsLibRedTest(BasicTypesQueryLibRedFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
