...
namespace EntityFrameworkCore.Jet.Metadata.Internal
{
    ...
    /// </summary>
    public class JetPropertyBuilderAnnotations : JetPropertyAnnotations
    {
        /// <summary>
        ///     This API supports the Entity Framework Core infrastructure and is not intended to be used
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        public JetPropertyBuilderAnnotations(
...
#pragma warning disable 109
        ...
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        public new virtual bool ValueGenerationStrategy(JetValueGenerationStrategy? value)
        {
            ...
            else if (value.Value == JetValueGenerationStrategy.IdentityColumn)
            {
                HiLoSequenceName(null);
                HiLoSequenceSchema(null);
            }
