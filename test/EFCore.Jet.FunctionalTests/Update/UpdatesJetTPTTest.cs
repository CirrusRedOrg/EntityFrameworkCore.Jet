...
public class UpdatesJetTPTTest(UpdatesJetTPTTest.UpdatesJetTPTFixture fixture, ITestOutputHelper testOutputHelper)
    : UpdatesJetTestBase<UpdatesJetTPTTest.UpdatesJetTPTFixture>(fixture, testOutputHelper)
{
