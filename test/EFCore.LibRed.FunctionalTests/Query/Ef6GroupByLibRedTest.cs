...
public class Ef6GroupByLibRedTest : Ef6GroupByTestBase<Ef6GroupByLibRedTest.Ef6GroupByLibRedFixture>
{
    public Ef6GroupByLibRedTest(Ef6GroupByLibRedFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
...
""");
    ...
    public class Ef6GroupByLibRedFixture : Ef6GroupByFixtureBase, ITestSqlLoggerFactory
    {
