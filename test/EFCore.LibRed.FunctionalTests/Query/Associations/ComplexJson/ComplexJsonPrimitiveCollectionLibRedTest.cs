...
public class ComplexJsonPrimitiveCollectionLibRedTest(ComplexJsonLibRedFixture fixture, ITestOutputHelper testOutputHelper)
    : ComplexJsonPrimitiveCollectionRelationalTestBase<ComplexJsonLibRedFixture>(fixture, testOutputHelper)
{
