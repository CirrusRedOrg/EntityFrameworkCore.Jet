...
{
    public class NorthwindCompiledQueryLibRedTest : NorthwindCompiledQueryTestBase<NorthwindQueryLibRedFixture<NoopModelCustomizer>>
    {
        public NorthwindCompiledQueryLibRedTest(NorthwindQueryLibRedFixture<NoopModelCustomizer> fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
