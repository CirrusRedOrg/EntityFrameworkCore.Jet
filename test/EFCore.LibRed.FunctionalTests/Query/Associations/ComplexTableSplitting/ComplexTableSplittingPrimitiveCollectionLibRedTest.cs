...
public class ComplexTableSplittingPrimitiveCollectionLibRedTest(
    ComplexTableSplittingLibRedFixture fixture,
    ITestOutputHelper testOutputHelper)
    : ComplexTableSplittingPrimitiveCollectionRelationalTestBase<ComplexTableSplittingLibRedFixture>(fixture, testOutputHelper)
{
