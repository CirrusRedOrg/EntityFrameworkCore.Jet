...
public class OwnedTableSplittingMiscellaneousLibRedTest(
    OwnedTableSplittingLibRedFixture fixture,
    ITestOutputHelper testOutputHelper)
    : OwnedTableSplittingMiscellaneousRelationalTestBase<OwnedTableSplittingLibRedFixture>(fixture, testOutputHelper)
{
