...
namespace EntityFrameworkCore.LibRed.Storage.Internal
{
    ...
    /// </summary>
    public class LibRedStringTypeMapping : StringTypeMapping
    {
        private readonly bool _keepLineBreakCharacters;
        private readonly int _maxSpecificSize;

        public static new LibRedStringTypeMapping Default { get; } = new();
        ...
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        protected LibRedStringTypeMapping(RelationalTypeMappingParameters parameters, bool keepLineBreakCharacters)
            : base(parameters)
        {
        ...
        protected override RelationalTypeMapping Clone(RelationalTypeMappingParameters parameters)
            => new LibRedStringTypeMapping(parameters, _keepLineBreakCharacters);
