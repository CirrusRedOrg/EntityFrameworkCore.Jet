...
LEFT JOIN (
    ...
    LEFT JOIN (
        SELECT `r5`.`RelationshipsTrunkEntityRelationshipsRootEntityId`, `r5`.`RelationshipsTrunkEntityId1`, `r5`.`Id1`, `r5`.`Name`, `r6`.`RelationshipsBranchEntityRelationshipsTrunkEntityRelationshipsR~`, `r6`.`RelationshipsBranchEntityRelationshipsTrunkEntityId1`, `r6`.`RelationshipsBranchEntityId1`, `r6`.`Id1` AS `Id10`, `r6`.`Name` AS `Name0`, `r5`.`OptionalReferenceLeaf_Name`, `r5`.`RequiredReferenceLeaf_Name`
        FROM `Root_CollectionTrunk_CollectionBranch` AS `r5`
        LEFT JOIN `Root_CollectionTrunk_CollectionBranch_CollectionLeaf` AS `r6` ON `r5`.`RelationshipsTrunkEntityRelationshipsRootEntityId` = `r6`.`RelationshipsBranchEntityRelationshipsTrunkEntityRelationshipsR~` AND `r5`.`RelationshipsTrunkEntityId1` = `r6`.`RelationshipsBranchEntityRelationshipsTrunkEntityId1` AND `r5`.`Id1` = `r6`.`RelationshipsBranchEntityId1`
    ...
    LEFT JOIN `Root_CollectionTrunk_RequiredReferenceBranch_CollectionLeaf` AS `r8` ON `r4`.`RelationshipsRootEntityId` = `r8`.`RelationshipsBranchEntityRelationshipsTrunkEntityRelationshipsR~` AND `r4`.`Id1` = `r8`.`RelationshipsBranchEntityRelationshipsTrunkEntityId1`
) AS `s1` ON `r`.`Id` = `s1`.`RelationshipsRootEntityId`)
LEFT JOIN (
    SELECT `r9`.`RelationshipsTrunkEntityRelationshipsRootEntityId`, `r9`.`Id1`, `r9`.`Name`, `r10`.`RelationshipsBranchEntityRelationshipsTrunkEntityRelationshipsR~`, `r10`.`RelationshipsBranchEntityId1`, `r10`.`Id1` AS `Id10`, `r10`.`Name` AS `Name0`, `r9`.`OptionalReferenceLeaf_Name`, `r9`.`RequiredReferenceLeaf_Name`
    FROM `Root_OptionalReferenceTrunk_CollectionBranch` AS `r9`
    LEFT JOIN `Root_OptionalReferenceTrunk_CollectionBranch_CollectionLeaf` AS `r10` ON `r9`.`RelationshipsTrunkEntityRelationshipsRootEntityId` = `r10`.`RelationshipsBranchEntityRelationshipsTrunkEntityRelationshipsR~` AND `r9`.`Id1` = `r10`.`RelationshipsBranchEntityId1`
) AS `s2` ON IIF(`r`.`OptionalReferenceTrunk_Name` IS NOT NULL, `r`.`Id`, NULL) = `s2`.`RelationshipsTrunkEntityRelationshipsRootEntityId`)
LEFT JOIN `Root_OptionalReferenceTrunk_OptionalReferenceBranch_CollB7BC1840` AS `r11` ON IIF(`r`.`OptionalReferenceTrunk_OptionalReferenceBranch_Name` IS NOT NULL, `r`.`Id`, NULL) = `r11`.`RelationshipsBranchEntityRelationshipsTrunkEntityRelationshipsR~`)
LEFT JOIN `Root_OptionalReferenceTrunk_RequiredReferenceBranch_CollB7BC1840` AS `r12` ON IIF(`r`.`OptionalReferenceTrunk_RequiredReferenceBranch_Name` IS NOT NULL, `r`.`Id`, NULL) = `r12`.`RelationshipsBranchEntityRelationshipsTrunkEntityRelationshipsR~`)
LEFT JOIN (
    SELECT `r13`.`RelationshipsTrunkEntityRelationshipsRootEntityId`, `r13`.`Id1`, `r13`.`Name`, `r14`.`RelationshipsBranchEntityRelationshipsTrunkEntityRelationshipsR~`, `r14`.`RelationshipsBranchEntityId1`, `r14`.`Id1` AS `Id10`, `r14`.`Name` AS `Name0`, `r13`.`OptionalReferenceLeaf_Name`, `r13`.`RequiredReferenceLeaf_Name`
    FROM `Root_RequiredReferenceTrunk_CollectionBranch` AS `r13`
    LEFT JOIN `Root_RequiredReferenceTrunk_CollectionBranch_CollectionLeaf` AS `r14` ON `r13`.`RelationshipsTrunkEntityRelationshipsRootEntityId` = `r14`.`RelationshipsBranchEntityRelationshipsTrunkEntityRelationshipsR~` AND `r13`.`Id1` = `r14`.`RelationshipsBranchEntityId1`
) AS `s3` ON `r`.`Id` = `s3`.`RelationshipsTrunkEntityRelationshipsRootEntityId`)
LEFT JOIN `Root_RequiredReferenceTrunk_OptionalReferenceBranch_CollB7BC1840` AS `r15` ON IIF(`r`.`RequiredReferenceTrunk_OptionalReferenceBranch_Name` IS NOT NULL, `r`.`Id`, NULL) = `r15`.`RelationshipsBranchEntityRelationshipsTrunkEntityRelationshipsR~`)
