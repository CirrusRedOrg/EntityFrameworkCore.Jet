...
public class OwnedJsonReferenceProjectionJetTest
    : OwnedJsonReferenceProjectionRelationalTestBase<OwnedJsonRelationshipsJetFixture>
{
    public OwnedJsonReferenceProjectionJetTest(OwnedJsonRelationshipsJetFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
