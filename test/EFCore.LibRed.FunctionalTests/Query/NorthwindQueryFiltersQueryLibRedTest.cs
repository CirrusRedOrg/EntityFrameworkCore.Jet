...
{
    public class NorthwindQueryFiltersQueryLibRedTest : NorthwindQueryFiltersQueryTestBase<NorthwindQueryLibRedFixture<NorthwindQueryFiltersCustomizer>>
    {
        public NorthwindQueryFiltersQueryLibRedTest(NorthwindQueryLibRedFixture<NorthwindQueryFiltersCustomizer> fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
