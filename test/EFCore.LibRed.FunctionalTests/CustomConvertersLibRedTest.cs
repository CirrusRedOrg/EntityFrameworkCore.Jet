...
{
    public class CustomConvertersLibRedTest : CustomConvertersTestBase<CustomConvertersLibRedTest.CustomConvertersLibRedFixture>
    {
        public CustomConvertersLibRedTest(CustomConvertersLibRedFixture fixture)
            : base(fixture)
        {
...
""");
        ...
        public class CustomConvertersLibRedFixture : CustomConvertersFixtureBase
        {
