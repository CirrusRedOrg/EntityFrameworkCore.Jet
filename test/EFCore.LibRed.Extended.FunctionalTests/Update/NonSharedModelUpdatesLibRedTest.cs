...
public class NonSharedModelUpdatesLibRedTest(NonSharedFixture fixture) : NonSharedModelUpdatesTestBase(fixture)
{
...
""");
    ...
    public virtual async Task Bulk_insert_result_set_mapping()
    {
        var contextFactory = await InitializeAsync<DbContext>(
            ...
            createTestStore: () => LibRedTestStore.GetOrCreateWithScriptPath(
                "Issue29502",
