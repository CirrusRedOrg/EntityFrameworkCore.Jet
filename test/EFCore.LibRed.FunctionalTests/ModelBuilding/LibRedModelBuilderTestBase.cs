...
public class LibRedModelBuilderTestBase : RelationalModelBuilderTest
{
        ...
        : RelationalNonRelationshipTestBase(fixture), IClassFixture<LibRedModelBuilderFixture>
    {
        ...
        public virtual void Index_has_a_filter_if_nonclustered_unique_with_nullable_properties()
        {
            ...
            entityTypeBuilder.Property(e => e.Name).HasColumnName("LibRedName");

            Assert.Equal("[LibRedName] IS NOT NULL", index.GetFilter());
    ...
    public abstract class LibRedComplexType(LibRedModelBuilderFixture fixture)
        : RelationalComplexTypeTestBase(fixture), IClassFixture<LibRedModelBuilderFixture>;

    public abstract class LibRedComplexCollection(LibRedModelBuilderFixture fixture)
        : RelationalComplexCollectionTestBase(fixture), IClassFixture<LibRedModelBuilderFixture>;
    ...
    public abstract class LibRedManyToOne(LibRedModelBuilderFixture fixture)
        : RelationalManyToOneTestBase(fixture), IClassFixture<LibRedModelBuilderFixture>;

    public abstract class LibRedOneToOne(LibRedModelBuilderFixture fixture)
        : RelationalOneToOneTestBase(fixture), IClassFixture<LibRedModelBuilderFixture>;
    ...
    public class LibRedModelBuilderFixture : RelationalModelBuilderFixture
    {
