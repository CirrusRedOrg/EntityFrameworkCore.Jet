...
public class UpdatesLibRedTest(UpdatesLibRedTest.UpdatesLibRedFixture fixture, ITestOutputHelper testOutputHelper)
    : UpdatesLibRedTestBase<UpdatesLibRedTest.UpdatesLibRedFixture>(fixture, testOutputHelper)
{
...
""");
    ...
    public class UpdatesLibRedFixture : UpdatesLibRedFixtureBase
    {
