...
namespace EntityFrameworkCore.Jet.Data
{
    ...
    {
        public static string? GetProvider(this DbConnectionStringBuilder builder, DataAccessProviderType providerType = DataAccessProviderType.Unconfigured)
        {
        ...
        public static void SetProvider(this DbConnectionStringBuilder builder, string value, DataAccessProviderType providerType = DataAccessProviderType.Unconfigured)
        {
            if (providerType == DataAccessProviderType.OleDb ||
                IsOleDb(builder))
            {
        ...
        public static void SetDataSource(this DbConnectionStringBuilder builder, string value, DataAccessProviderType providerType = DataAccessProviderType.Unconfigured)
        {
            if (providerType == DataAccessProviderType.OleDb ||
                IsOleDb(builder))
            {
        ...
        public static void SetUserId(this DbConnectionStringBuilder builder, string value, DataAccessProviderType providerType = DataAccessProviderType.Unconfigured)
        {
            if (providerType == DataAccessProviderType.OleDb ||
                IsOleDb(builder))
            {
        ...
        public static void SetPassword(this DbConnectionStringBuilder builder, string value, DataAccessProviderType providerType = DataAccessProviderType.Unconfigured)
        {
            if (providerType == DataAccessProviderType.OleDb ||
                IsOleDb(builder))
            {
        ...
        public static void SetSystemDatabase(this DbConnectionStringBuilder builder, string value, DataAccessProviderType providerType = DataAccessProviderType.Unconfigured)
        {
            if (providerType == DataAccessProviderType.OleDb ||
                IsOleDb(builder))
            {
        ...
        public static string? GetDatabasePassword(this DbConnectionStringBuilder builder, DataAccessProviderType providerType = DataAccessProviderType.Unconfigured)
        {
            if (providerType == DataAccessProviderType.OleDb ||
                IsOleDb(builder))
            {
        ...
        public static void SetDatabasePassword(this DbConnectionStringBuilder builder, string value, DataAccessProviderType providerType = DataAccessProviderType.Unconfigured)
        {
            if (providerType == DataAccessProviderType.OleDb ||
                IsOleDb(builder))
            {
