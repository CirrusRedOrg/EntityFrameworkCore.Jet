...
public class TPTFiltersInheritanceQueryLibRedTest : TPTFiltersInheritanceQueryTestBase<TPTFiltersInheritanceQueryLibRedFixture>
{
    public TPTFiltersInheritanceQueryLibRedTest(
        TPTFiltersInheritanceQueryLibRedFixture fixture,
