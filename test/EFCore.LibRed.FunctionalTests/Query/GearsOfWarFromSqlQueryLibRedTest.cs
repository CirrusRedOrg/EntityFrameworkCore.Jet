...
{
    public class GearsOfWarFromSqlQueryLibRedTest : GearsOfWarFromSqlQueryTestBase<GearsOfWarQueryLibRedFixture>
    {
        public GearsOfWarFromSqlQueryLibRedTest(GearsOfWarQueryLibRedFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
