...
public class OwnedJsonNoTrackingProjectionJetTest
    : OwnedJsonNoTrackingProjectionRelationalTestBase<OwnedJsonRelationshipsJetFixture>
{
    public OwnedJsonNoTrackingProjectionJetTest(OwnedJsonRelationshipsJetFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
