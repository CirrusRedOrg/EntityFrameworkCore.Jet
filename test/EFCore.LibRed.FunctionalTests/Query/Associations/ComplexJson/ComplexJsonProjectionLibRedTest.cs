...
public class ComplexJsonProjectionLibRedTest(ComplexJsonLibRedFixture fixture, ITestOutputHelper testOutputHelper)
    : ComplexJsonProjectionRelationalTestBase<ComplexJsonLibRedFixture>(fixture, testOutputHelper)
{
