...
public class UpdatesLibRedTPTTest(UpdatesLibRedTPTTest.UpdatesLibRedTPTFixture fixture, ITestOutputHelper testOutputHelper)
    : UpdatesLibRedTestBase<UpdatesLibRedTPTTest.UpdatesLibRedTPTFixture>(fixture, testOutputHelper)
{
...
""");
    ...
    public class UpdatesLibRedTPTFixture : UpdatesLibRedFixtureBase
    {
