...
public class AdHocNavigationsQueryLibRedTest(NonSharedFixture fixture) : AdHocNavigationsQueryRelationalTestBase(fixture)
{
...
WHERE `p`.`Discriminator` = 'ProposalLeave'
""");
    }
