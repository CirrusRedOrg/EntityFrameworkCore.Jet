...
{
    public abstract class ConnectionInterceptionLibRedTestBase(
        ConnectionInterceptionLibRedTestBase.InterceptionLibRedFixtureBase fixture)
        : ConnectionInterceptionTestBase(fixture)
    {
        ...
        public class ConnectionInterceptionLibRedTest(ConnectionInterceptionLibRedTest.InterceptionLibRedFixture fixture)
            : ConnectionInterceptionLibRedTestBase(fixture),
                IClassFixture<ConnectionInterceptionLibRedTest.InterceptionLibRedFixture>
        {
        ...
        public class ConnectionInterceptionWithDiagnosticsLibRedTest(
            ConnectionInterceptionWithDiagnosticsLibRedTest.InterceptionLibRedFixture fixture)
            : ConnectionInterceptionLibRedTestBase(fixture),
                IClassFixture<ConnectionInterceptionWithDiagnosticsLibRedTest.InterceptionLibRedFixture>
        {
            public class InterceptionLibRedFixture : InterceptionLibRedFixtureBase
            {
