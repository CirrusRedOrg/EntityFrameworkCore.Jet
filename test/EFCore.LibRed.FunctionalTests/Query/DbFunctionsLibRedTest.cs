...
{
    public class DbFunctionsLibRedTest : NorthwindDbFunctionsQueryRelationalTestBase<NorthwindQueryLibRedFixture<NoopModelCustomizer>>
    {
        public DbFunctionsLibRedTest(
            NorthwindQueryLibRedFixture<NoopModelCustomizer> fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
        ...
        [ConditionalTheory(Skip = "No escape character support in LibRed")]
...
""");
        ...
        [ConditionalTheory(Skip = "No ecollate support in LibRed")]
...
""");
        ...
        [ConditionalTheory(Skip = "No collate support in LibRed")]
...
FROM `Orders` AS `o`
WHERE CBOOL(ISDATE(IIF((`o`.`OrderDate` & '') IS NULL, '', (`o`.`OrderDate` & ''))))
""");
        }
