    ...
    public virtual async Task Create_table_with_sparse_column()
    {
        await Test(
            ...
            model =>
            {
                ...
                Assert.True((bool?)column[JetAnnotationNames.Sparse]);
            });
    ...
    public virtual async Task Create_index_clustered()
    {
        await Test(
            ...
            model =>
            {
                var table = Assert.Single(model.Tables);
                var index = Assert.Single(table.Indexes);
                Assert.True((bool?)index[JetAnnotationNames.Clustered]);
    ...
    public virtual async Task Add_primary_key_nonclustered()
    {
        await Test(
            ...
            model =>
            {
                ...
                Assert.False((bool?)primaryKey![JetAnnotationNames.Clustered]);
            });
    ...
    public virtual async Task Create_temporal_table_default_column_mappings_and_default_history_table()
    {
        await Test(
            ...
            model =>
            {
                ...
                Assert.Equal(true, table[JetAnnotationNames.IsTemporal]);
                Assert.Equal("CustomerHistory", table[JetAnnotationNames.TemporalHistoryTableName]);
                Assert.Equal("SystemTimeStart", table[JetAnnotationNames.TemporalPeriodStartPropertyName]);
                Assert.Equal("SystemTimeEnd", table[JetAnnotationNames.TemporalPeriodEndPropertyName]);
    ...
    public virtual async Task Create_temporal_table_custom_column_mappings_and_default_history_table()
    {
        await Test(
            ...
            model =>
            {
                ...
                Assert.Equal(true, table[JetAnnotationNames.IsTemporal]);
                Assert.Equal("CustomerHistory", table[JetAnnotationNames.TemporalHistoryTableName]);
                Assert.Equal("Start", table[JetAnnotationNames.TemporalPeriodStartPropertyName]);
                Assert.Equal("End", table[JetAnnotationNames.TemporalPeriodEndPropertyName]);
    ...
    public virtual async Task Create_temporal_table_default_column_mappings_and_custom_history_table()
    {
        await Test(
            ...
            model =>
            {
                ...
                Assert.Equal("SystemTimeStart", table[JetAnnotationNames.TemporalPeriodStartPropertyName]);
                Assert.Equal("SystemTimeEnd", table[JetAnnotationNames.TemporalPeriodEndPropertyName]);
                Assert.Equal("HistoryTable", table[JetAnnotationNames.TemporalHistoryTableName]);
    ...
    public virtual async Task Create_temporal_table_with_explicitly_defined_schema()
    {
        await Test(
            ...
            model =>
            {
                ...
                Assert.Equal(true, table[JetAnnotationNames.IsTemporal]);
                Assert.Equal("CustomersHistory", table[JetAnnotationNames.TemporalHistoryTableName]);
                Assert.Equal("SystemTimeStart", table[JetAnnotationNames.TemporalPeriodStartPropertyName]);
                Assert.Equal("SystemTimeEnd", table[JetAnnotationNames.TemporalPeriodEndPropertyName]);
    ...
    public virtual async Task Create_temporal_table_with_default_model_schema()
    {
        await Test(
            ...
            model =>
            {
                ...
                Assert.Equal(true, table[JetAnnotationNames.IsTemporal]);
                Assert.Equal("CustomersHistory", table[JetAnnotationNames.TemporalHistoryTableName]);
                Assert.Equal("myDefaultSchema", table[JetAnnotationNames.TemporalHistoryTableSchema]);
                Assert.Equal("SystemTimeStart", table[JetAnnotationNames.TemporalPeriodStartPropertyName]);
                Assert.Equal("SystemTimeEnd", table[JetAnnotationNames.TemporalPeriodEndPropertyName]);
        ...
        Create_temporal_table_with_default_model_schema_specified_after_entity_definition_and_history_table_schema_specified_explicitly()
    {
        await Test(
            ...
            model =>
            {
                ...
                Assert.Equal("myDefaultSchema", table.Schema);
                Assert.Equal(true, table[JetAnnotationNames.IsTemporal]);
                Assert.Equal("History", table[JetAnnotationNames.TemporalHistoryTableName]);
                Assert.Equal("myHistorySchema", table[JetAnnotationNames.TemporalHistoryTableSchema]);
                Assert.Equal("SystemTimeStart", table[JetAnnotationNames.TemporalPeriodStartPropertyName]);
                Assert.Equal("SystemTimeEnd", table[JetAnnotationNames.TemporalPeriodEndPropertyName]);
    ...
    public virtual async Task Create_temporal_table_with_default_schema_for_model_changed_and_explicit_history_table_schema_provided()
    {
        await Test(
            ...
            model =>
            {
                ...
                Assert.Equal(true, table[JetAnnotationNames.IsTemporal]);
                Assert.Equal("HistoryTable", table[JetAnnotationNames.TemporalHistoryTableName]);
                Assert.Equal("historySchema", table[JetAnnotationNames.TemporalHistoryTableSchema]);
                Assert.Equal("SystemTimeStart", table[JetAnnotationNames.TemporalPeriodStartPropertyName]);
                Assert.Equal("SystemTimeEnd", table[JetAnnotationNames.TemporalPeriodEndPropertyName]);
    ...
    public virtual async Task Rename_temporal_table_schema_when_history_table_doesnt_have_its_schema_specified()
    {
        await Test(
            ...
            model =>
            {
                ...
                Assert.Equal("End", table[JetAnnotationNames.TemporalPeriodEndPropertyName]);
                Assert.Equal("HistoryTable", table[JetAnnotationNames.TemporalHistoryTableName]);
                Assert.Equal("mySchema2", table[JetAnnotationNames.TemporalHistoryTableSchema]);
    ...
    public virtual async Task Rename_temporal_table_schema_and_history_table_name_when_history_table_doesnt_have_its_schema_specified()
    {
        await Test(
            ...
            model =>
            {
                ...
                Assert.Equal("Start", table[JetAnnotationNames.TemporalPeriodStartPropertyName]);
                Assert.Equal("End", table[JetAnnotationNames.TemporalPeriodEndPropertyName]);
                Assert.Equal("HistoryTable2", table[JetAnnotationNames.TemporalHistoryTableName]);
                Assert.Equal("mySchema2", table[JetAnnotationNames.TemporalHistoryTableSchema]);
    ...
    public virtual async Task Rename_history_table()
    {
        await Test(
            ...
            model =>
            {
                ...
                Assert.Equal("Start", table[JetAnnotationNames.TemporalPeriodStartPropertyName]);
                Assert.Equal("End", table[JetAnnotationNames.TemporalPeriodEndPropertyName]);
                Assert.Equal("RenamedHistoryTable", table[JetAnnotationNames.TemporalHistoryTableName]);
    ...
    public virtual async Task Change_history_table_schema()
    {
        await Test(
            ...
            model =>
            {
                ...
                Assert.Equal("End", table[JetAnnotationNames.TemporalPeriodEndPropertyName]);
                Assert.Equal("HistoryTable", table[JetAnnotationNames.TemporalHistoryTableName]);
                Assert.Equal("modifiedHistorySchema", table[JetAnnotationNames.TemporalHistoryTableSchema]);
    ...
    public virtual async Task Rename_temporal_table_history_table_and_their_schemas()
    {
        await Test(
            ...
            model =>
            {
                ...
                Assert.Equal("End", table[JetAnnotationNames.TemporalPeriodEndPropertyName]);
                Assert.Equal("RenamedHistoryTable", table[JetAnnotationNames.TemporalHistoryTableName]);
                Assert.Equal("newHistorySchema", table[JetAnnotationNames.TemporalHistoryTableSchema]);
        ...
        Convert_temporal_table_with_default_column_mappings_and_custom_history_table_to_normal_table_keep_period_columns()
    {
        await Test(
            ...
            model =>
            {
                var table = Assert.Single(model.Tables);
                Assert.Equal("Customer", table.Name);
                Assert.Null(table[JetAnnotationNames.IsTemporal]);
                Assert.Null(table[JetAnnotationNames.TemporalHistoryTableName]);
        ...
        await Test(
            ...
            builder => builder.Entity(
                "Customer", e =>
                {
                    ...
                    e.Metadata[JetAnnotationNames.TemporalPeriodStartPropertyName] = "PeriodStart";
                    e.Metadata[JetAnnotationNames.TemporalPeriodEndPropertyName] = "PeriodEnd";
                }),
            model =>
            {
                var table = Assert.Single(model.Tables);
    ...
    public virtual async Task Convert_normal_table_to_temporal_table_default_column_mappings_and_default_history_table()
    {
        await Test(
            ...
            model =>
            {
                ...
                Assert.Equal("Customer", table.Name);
                Assert.Equal(true, table[JetAnnotationNames.IsTemporal]);
                Assert.NotNull(table[JetAnnotationNames.TemporalHistoryTableName]);
                Assert.Equal("Start", table[JetAnnotationNames.TemporalPeriodStartPropertyName]);
                Assert.Equal("End", table[JetAnnotationNames.TemporalPeriodEndPropertyName]);
    ...
    public virtual async Task Rename_period_properties_of_temporal_table()
    {
        await Test(
            ...
            model =>
            {
                var table = Assert.Single(model.Tables);
                Assert.Equal("Customer", table.Name);
                Assert.NotNull(table[JetAnnotationNames.IsTemporal]);
                Assert.Equal("HistoryTable", table[JetAnnotationNames.TemporalHistoryTableName]);
                Assert.Equal("ModifiedStart", table[JetAnnotationNames.TemporalPeriodStartPropertyName]);
                Assert.Equal("ModifiedEnd", table[JetAnnotationNames.TemporalPeriodEndPropertyName]);
    ...
    public virtual async Task History_table_schema_not_created_if_we_know_it_already_exists1()
    {
        await Test(
            ...
            model =>
            {
                ...
                Assert.True(model.Tables.All(x => x[JetAnnotationNames.TemporalHistoryTableSchema] as string == "mySchema"));
            });
    ...
    public virtual async Task History_table_schema_not_created_if_we_know_it_already_exists2()
    {
        await Test(
            ...
            model =>
            {
                Assert.Equal(2, model.Tables.Count);
                Assert.True(model.Tables.All(x => x.Schema == "mySchema"));
                Assert.True(model.Tables.All(x => x[JetAnnotationNames.TemporalHistoryTableSchema] as string == "mySchema2"));
            });
    ...
    public virtual async Task History_table_schema_renamed_to_one_exisiting_in_the_model()
    {
        await Test(
            ...
            model =>
            {
                ...
                Assert.Equal("mySchema2", customers[JetAnnotationNames.TemporalHistoryTableSchema]);

                var orders = model.Tables.First(t => t.Name == "Orders");
                Assert.Equal("mySchema2", orders.Schema);
                Assert.Equal("mySchema", orders[JetAnnotationNames.TemporalHistoryTableSchema]);
            });
    ...
    public virtual async Task Temporal_table_with_default_global_schema_noop_migtation_doesnt_generate_unnecessary_steps()
    {
        await Test(
            ...
            model =>
            {
                ...
                Assert.Equal("myDefaultSchema", customers[JetAnnotationNames.TemporalHistoryTableSchema]);
            });
    ...
    public virtual async Task Temporal_table_with_default_global_schema_changing_global_schema()
    {
        await Test(
            ...
            model =>
            {
                ...
                Assert.Equal("myModifiedDefaultSchema", customers[JetAnnotationNames.TemporalHistoryTableSchema]);
            });
    ...
    public virtual async Task Temporal_table_rename_and_delete_columns_and_also_rename_history_table_in_one_migration()
    {
        await Test(
            ...
            model =>
            {
                ...
                Assert.Equal("Start", table[JetAnnotationNames.TemporalPeriodStartPropertyName]);
                Assert.Equal("End", table[JetAnnotationNames.TemporalPeriodEndPropertyName]);
                Assert.Equal("ModifiedHistoryTable", table[JetAnnotationNames.TemporalHistoryTableName]);
