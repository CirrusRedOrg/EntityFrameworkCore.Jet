...
public class GraphUpdatesLibRedTptIdentityTest(GraphUpdatesLibRedTptIdentityTest.LibRedFixture fixture)
    : GraphUpdatesLibRedTestBase<GraphUpdatesLibRedTptIdentityTest.LibRedFixture>(fixture)
{
