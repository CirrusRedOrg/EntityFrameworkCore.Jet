...
public class OwnedJsonPrimitiveCollectionLibRedTest(OwnedJsonLibRedFixture fixture, ITestOutputHelper testOutputHelper)
    : OwnedJsonPrimitiveCollectionRelationalTestBase<OwnedJsonLibRedFixture>(fixture, testOutputHelper)
{
