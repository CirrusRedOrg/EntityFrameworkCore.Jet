...
public class TPCGearsOfWarQueryLibRedFixture : TPCGearsOfWarQueryRelationalFixture
{
    ...
    {
        // Drop constraint to workaround LibRed limitation regarding compound foreign keys and NULL.
