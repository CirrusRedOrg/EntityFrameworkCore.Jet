...
public class ComplexJsonCollectionLibRedTest(ComplexJsonLibRedFixture fixture, ITestOutputHelper testOutputHelper)
    : ComplexJsonCollectionRelationalTestBase<ComplexJsonLibRedFixture>(fixture, testOutputHelper)
{
