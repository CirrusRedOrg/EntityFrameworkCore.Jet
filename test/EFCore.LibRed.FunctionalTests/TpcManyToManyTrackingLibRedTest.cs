...
public class TpcManyToManyTrackingLibRedTest(TpcManyToManyTrackingLibRedTest.TpcManyToManyTrackingLibRedFixture fixture)
    : ManyToManyTrackingLibRedTestBase<TpcManyToManyTrackingLibRedTest.TpcManyToManyTrackingLibRedFixture>(fixture)
{
    public class TpcManyToManyTrackingLibRedFixture : ManyToManyTrackingLibRedFixtureBase
    {
        protected override string StoreName
            => "TpcManyToManyTrackingLibRedTest";
