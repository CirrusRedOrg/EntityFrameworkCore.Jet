...
{
    public class NorthwindIncludeQueryLibRedTest : NorthwindIncludeQueryRelationalTestBase<NorthwindQueryLibRedFixture<NoopModelCustomizer>>
    {
        private bool SupportsOffset => true;

        // ReSharper disable once UnusedParameter.Local
        public NorthwindIncludeQueryLibRedTest(NorthwindQueryLibRedFixture<NoopModelCustomizer> fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
