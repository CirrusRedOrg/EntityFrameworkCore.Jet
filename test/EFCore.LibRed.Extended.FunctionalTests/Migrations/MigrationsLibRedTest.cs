...
public class MigrationsLibRedTest : MigrationsTestBase<MigrationsLibRedTest.MigrationsLibRedFixture>
{
    ...
    public MigrationsLibRedTest(MigrationsLibRedFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
...
""");
    ...
    public override async Task Create_index_unique()
    {
        ...
        AssertSql(
            """
CREATE UNIQUE INDEX `IX_People_FirstName_LastName` ON `People` (`FirstName`, `LastName`) WITH IGNORE NULL;
""");
    }
...
""");
    ...
    public class MigrationsLibRedFixture : MigrationsFixtureBase
    {
        protected override string StoreName
            => nameof(MigrationsLibRedTest);
        ...
        protected override IServiceCollection AddServices(IServiceCollection serviceCollection)
            => base.AddServices(serviceCollection)
                .AddScoped<IDatabaseModelFactory, LibRedDatabaseModelFactory>();
    }
}
