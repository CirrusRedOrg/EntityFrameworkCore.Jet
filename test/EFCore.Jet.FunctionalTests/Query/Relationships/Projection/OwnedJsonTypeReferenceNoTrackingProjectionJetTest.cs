...
public class OwnedJsonTypeReferenceNoTrackingProjectionJetTest
    : ReferenceProjectionTestBase<OwnedJsonTypeRelationshipsJetFixture>
{
    public OwnedJsonTypeReferenceNoTrackingProjectionJetTest(OwnedJsonTypeRelationshipsJetFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
