...
{
    public class ConvertToProviderTypesLibRedTest(ConvertToProviderTypesLibRedTest.ConvertToProviderTypesLibRedFixture fixture)
            ...
            ConvertToProviderTypesLibRedTest.ConvertToProviderTypesLibRedFixture>(fixture)
    {
        ...
        public class ConvertToProviderTypesLibRedFixture : ConvertToProviderTypesFixtureBase
        {
