...
public class OwnedTableSplittingProjectionLibRedTest(OwnedTableSplittingLibRedFixture fixture, ITestOutputHelper testOutputHelper)
    : OwnedTableSplittingProjectionRelationalTestBase<OwnedTableSplittingLibRedFixture>(fixture, testOutputHelper)
{
...
ORDER BY `r`.`Id`, `r0`.`AssociateTypeRootEntityId`, `r0`.`Id`, `r1`.`AssociateTypeRootEntityId`, `r1`.`Id`
""");
        }
    }
