...
public class TPCInheritanceBulkUpdatesLibRedTest(
    TPCInheritanceBulkUpdatesLibRedFixture fixture,
    ITestOutputHelper testOutputHelper)
    : TPCInheritanceBulkUpdatesTestBase<TPCInheritanceBulkUpdatesLibRedFixture>(fixture, testOutputHelper)
{
    [ConditionalFact]
