...
{
    public class ComplexNavigationsOwnedQueryJetFixture
        : ComplexNavigationsOwnedQueryRelationalFixtureBase<JetTestStore>
    {
        ...
        public ComplexNavigationsOwnedQueryJetFixture()
        {
