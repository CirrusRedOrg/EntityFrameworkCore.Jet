...
public class OptionalDependentQueryLibRedTest : OptionalDependentQueryTestBase<OptionalDependentQueryLibRedFixture>
{
    public OptionalDependentQueryLibRedTest(OptionalDependentQueryLibRedFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
