...
public class TPTInheritanceBulkUpdatesLibRedTest(
    TPTInheritanceBulkUpdatesLibRedFixture fixture,
    ITestOutputHelper testOutputHelper)
    : TPTInheritanceBulkUpdatesTestBase<TPTInheritanceBulkUpdatesLibRedFixture>(fixture, testOutputHelper)
{
    [ConditionalFact]
