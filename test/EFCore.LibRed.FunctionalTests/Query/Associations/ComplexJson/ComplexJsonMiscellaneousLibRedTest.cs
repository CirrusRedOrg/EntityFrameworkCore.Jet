...
public class ComplexJsonMiscellaneousLibRedTest(ComplexJsonLibRedFixture fixture, ITestOutputHelper testOutputHelper)
    : ComplexJsonMiscellaneousRelationalTestBase<ComplexJsonLibRedFixture>(fixture, testOutputHelper)
{
