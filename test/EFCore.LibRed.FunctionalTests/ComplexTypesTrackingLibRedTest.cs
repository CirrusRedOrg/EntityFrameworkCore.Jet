...
public class ComplexTypesTrackingLibRedTest(
    ComplexTypesTrackingLibRedTest.LibRedFixture fixture,
    ITestOutputHelper testOutputHelper)
    : ComplexTypesTrackingLibRedTestBase<ComplexTypesTrackingLibRedTest.LibRedFixture>(fixture, testOutputHelper)
{
    public class LibRedFixture : LibRedFixtureBase
    {
        protected override string StoreName
            => nameof(ComplexTypesTrackingLibRedTest);
    }
}

public class ComplexTypesTrackingProxiesLibRedTest(
    ComplexTypesTrackingProxiesLibRedTest.LibRedFixture fixture,
    ITestOutputHelper testOutputHelper)
    : ComplexTypesTrackingLibRedTestBase<ComplexTypesTrackingProxiesLibRedTest.LibRedFixture>(fixture, testOutputHelper)
{
    ...
    {
        protected override string StoreName
            => nameof(ComplexTypesTrackingProxiesLibRedTest);
...
public abstract class ComplexTypesTrackingLibRedTestBase<TFixture> : ComplexTypesTrackingRelationalTestBase<TFixture>
    where TFixture : ComplexTypesTrackingLibRedTestBase<TFixture>.LibRedFixtureBase, new()
{
    protected ComplexTypesTrackingLibRedTestBase(TFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture, testOutputHelper)
    {
    }

    public abstract class LibRedFixtureBase : RelationalFixtureBase
    {
