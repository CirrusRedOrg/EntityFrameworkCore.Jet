...
{
    public class NorthwindWhereQueryLibRedTest : NorthwindWhereQueryRelationalTestBase<
        NorthwindQueryLibRedFixture<NoopModelCustomizer>>
    {
        public NorthwindWhereQueryLibRedTest(
...
""");
        ...
        public override async Task Where_Contains_and_comparison(bool async)
        {
            ...
            AssertSql(
                """
@customerIds1='ALFKI' (Size = 5)
@customerIds2='FISSA' (Size = 5)
@customerIds3='WHITC' (Size = 5)
