...
using EntityFrameworkCore.LibRed.Extended.FunctionalTests.TestModels.Northwind;
...
{
    public partial class NorthwindMiscellaneousQueryLibRedTest : NorthwindMiscellaneousQueryRelationalTestBase<NorthwindQueryLibRedFixture<NoopModelCustomizer>>
    {
        public NorthwindMiscellaneousQueryLibRedTest(NorthwindQueryLibRedFixture<NoopModelCustomizer> fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
            ClearLog();
...
""");
        ...
        public virtual void Cache_key_contexts_are_detached()
        {
            var weakRef = Scoper(
                () =>
                {
                    var context = new NorthwindLibRedContext(Fixture.CreateOptions());
...
SELECT EXISTS (
    ...
    WHERE (
        ...
        LEFT JOIN `Customers` AS `c1` ON `o1`.`CustomerID` = `c1`.`CustomerID`
        WHERE `c`.`CustomerID` = `o1`.`CustomerID`
        ORDER BY `o1`.`OrderDate`) IS NULL AND `o`.`CustomerID` IS NULL)) AND `o`.`OrderID` < 11000) AS `Complex`
FROM `Customers` AS `c`
WHERE `c`.`CustomerID` LIKE 'F%'
ORDER BY `c`.`CustomerID`
""");
        ...
        public override async Task Client_code_using_instance_method_throws(bool async)
        {
            Assert.Equal(
                CoreStrings.ClientProjectionCapturingConstantInMethodInstance(
                    "EntityFrameworkCore.LibRed.Extended.FunctionalTests.Query.NorthwindMiscellaneousQueryLibRedTest",
                    "InstanceMethod"),
        ...
        public override async Task Client_code_unknown_method(bool async)
        {
            await AssertTranslationFailedWithDetails(
                ...
                CoreStrings.QueryUnableToTranslateMethod(
                    "Microsoft.EntityFrameworkCore.Query.NorthwindMiscellaneousQueryTestBase<EntityFrameworkCore.LibRed.Extended.FunctionalTests.Query.NorthwindQueryLibRedFixture<Microsoft.EntityFrameworkCore.TestUtilities.NoopModelCustomizer>>",
...
""");
        ...
        public override async Task Contains_over_concatenated_column_and_constant(bool async)
        {
            ...
            AssertSql(
                """
@data1='ALFKISomeConstant' (Size = 255)
@data2='ANATRSomeConstant' (Size = 255)
@data3='ALFKIX' (Size = 255)
...
""");
        ...
        public override async Task Contains_over_concatenated_columns_both_fixed_length(bool async)
        {
            ...
            AssertSql(
                """
@data1='ALFKIALFKI' (Size = 10)
@data2='ALFKI' (Size = 10)
@data3='ANATRAna Trujillo Emparedados y helados' (Size = -1)
@data4='ANATRANATR' (Size = 10)
...
@data1='ALFKISomeVariable' (Size = 255)
@data2='ANATRSomeVariable' (Size = 255)
@data3='ALFKIX' (Size = 255)
