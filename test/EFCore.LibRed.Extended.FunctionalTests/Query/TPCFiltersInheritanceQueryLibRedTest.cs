...
public class TPCFiltersInheritanceQueryLibRedTest : TPCFiltersInheritanceQueryTestBase<TPCFiltersInheritanceQueryLibRedFixture>
{
    public TPCFiltersInheritanceQueryLibRedTest(
        TPCFiltersInheritanceQueryLibRedFixture fixture,
