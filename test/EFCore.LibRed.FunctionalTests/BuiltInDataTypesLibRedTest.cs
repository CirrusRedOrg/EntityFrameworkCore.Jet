...
{
    public class BuiltInDataTypesLibRedTest : BuiltInDataTypesTestBase<BuiltInDataTypesLibRedTest.BuiltInDataTypesLibRedFixture>
    {
        private static readonly string _eol = Environment.NewLine;

        public BuiltInDataTypesLibRedTest(BuiltInDataTypesLibRedFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
...
parameters,
            ...
            MappedNullableDataTypesWithIdentity entity, int id)
        {
            ...
            Assert.Null(entity.UshortAsSmallint);
            Assert.Null(entity.SbyteAsTinyint);
            Assert.Equal(entity.BoolAsBit, false);//Bit in LibRed is non nullable so can not be null
            Assert.Null(entity.DecimalAsMoney);
            //Assert.Null(entity.DecimalAsSmallmoney);
            Assert.Null(entity.DoubleAsFloat);
            Assert.Null(entity.FloatAsReal);
        ...
        public class BuiltInDataTypesLibRedFixture : BuiltInDataTypesFixtureBase
        {
            ...
            public override DbContextOptionsBuilder AddOptions(DbContextOptionsBuilder builder)
            {
                ...
                new LibRedDbContextOptionsBuilder(options).MinBatchSize(1);
        ...
        public override async Task Can_insert_and_read_back_all_non_nullable_data_types()
        {
            ...
            using (var context = CreateContext())
            {
                ...
                AssertEqualIfMapped(
                    ...
                    () => dt.TestDateTime);
                AssertEqualIfMapped(
                    entityType, LibRedTestHelpers.GetExpectedValue(new DateTimeOffset(DateTime.Parse("01/01/2000 12:34:56"), TimeSpan.FromHours(-8.0))),
