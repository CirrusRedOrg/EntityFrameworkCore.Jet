...
public class PrecompiledQueryLibRedTest(
    PrecompiledQueryLibRedTest.PrecompiledQueryLibRedFixture fixture,
    ITestOutputHelper testOutputHelper)
    : PrecompiledQueryRelationalTestBase(fixture, testOutputHelper),
        IClassFixture<PrecompiledQueryLibRedTest.PrecompiledQueryLibRedFixture>
{
...
""");
    ...
    public virtual async Task LibRedAggregateFunctionExpression()
    {
        await Test(
            """
_ = context.Blogs
...
""");
    ...
    // LibRedOpenJsonExpression is covered by PrecompiledQueryRelationalTestBase.Contains_with_parameterized_collection
...
""");
    ...
    public class PrecompiledQueryLibRedFixture : PrecompiledQueryRelationalFixture
    {
        ...
        public override DbContextOptionsBuilder AddOptions(DbContextOptionsBuilder builder)
        {
            ...
            var LibRedOptionsBuilder = new LibRedDbContextOptionsBuilder(builder);
            LibRedOptionsBuilder.ExecutionStrategy(d => new NonRetryingExecutionStrategy(d));
