...
LEFT JOIN (
    ...
    LEFT JOIN `Root_CollectionTrunk_OptionalReferenceBranch_OptionalRef3DABF2A6` AS `r2` ON `r1`.`RelationshipsTrunkEntityRelationshipsRootEntityId` = `r2`.`RelationshipsBranchEntityRelationshipsTrunkEntityRelationshipsR~` AND `r1`.`RelationshipsTrunkEntityId1` = `r2`.`RelationshipsBranchEntityRelationshipsTrunkEntityId1`)
    LEFT JOIN `Root_CollectionTrunk_OptionalReferenceBranch_RequiredRefEAD29521` AS `r3` ON `r1`.`RelationshipsTrunkEntityRelationshipsRootEntityId` = `r3`.`RelationshipsBranchEntityRelationshipsTrunkEntityRelationshipsR~` AND `r1`.`RelationshipsTrunkEntityId1` = `r3`.`RelationshipsBranchEntityRelationshipsTrunkEntityId1`)
    ...
    LEFT JOIN `Root_CollectionTrunk_RequiredReferenceBranch_OptionalRef6DAA31E7` AS `r5` ON `r4`.`RelationshipsTrunkEntityRelationshipsRootEntityId` = `r5`.`RelationshipsBranchEntityRelationshipsTrunkEntityRelationshipsR~` AND `r4`.`RelationshipsTrunkEntityId1` = `r5`.`RelationshipsBranchEntityRelationshipsTrunkEntityId1`)
    LEFT JOIN `Root_CollectionTrunk_RequiredReferenceBranch_RequiredRefF4CAB043` AS `r6` ON `r4`.`RelationshipsTrunkEntityRelationshipsRootEntityId` = `r6`.`RelationshipsBranchEntityRelationshipsTrunkEntityRelationshipsR~` AND `r4`.`RelationshipsTrunkEntityId1` = `r6`.`RelationshipsBranchEntityRelationshipsTrunkEntityId1`)
    LEFT JOIN (
...
LEFT JOIN (
    ...
    LEFT JOIN `Root_RequiredReferenceTrunk_CollectionBranch_OptionalRef5715C630` AS `r2` ON `r1`.`RelationshipsTrunkEntityRelationshipsRootEntityId` = `r2`.`RelationshipsBranchEntityRelationshipsTrunkEntityRelationshipsR~` AND `r1`.`Id1` = `r2`.`RelationshipsBranchEntityId1`)
    LEFT JOIN `Root_RequiredReferenceTrunk_CollectionBranch_RequiredRef0E54E2D4` AS `r3` ON `r1`.`RelationshipsTrunkEntityRelationshipsRootEntityId` = `r3`.`RelationshipsBranchEntityRelationshipsTrunkEntityRelationshipsR~` AND `r1`.`Id1` = `r3`.`RelationshipsBranchEntityId1`)
...
ORDER BY `r`.`Id`, `r0`.`RelationshipsRootEntityId`, `s`.`RelationshipsTrunkEntityRelationshipsRootEntityId`, `s`.`Id1`, `s`.`RelationshipsBranchEntityRelationshipsTrunkEntityRelationshipsR~`, `s`.`RelationshipsBranchEntityId1`, `s`.`RelationshipsBranchEntityRelationshipsTrunkEntityRelatio5A630C8B`, `s`.`RelationshipsBranchEntityId10`, `s`.`RelationshipsBranchEntityRelationshipsTrunkEntityRelatio3D99058E`, `s`.`RelationshipsBranchEntityId11`
""");
    }
...
LEFT JOIN `Root_RequiredReferenceTrunk_RequiredReferenceBranch_Opti0541F6F6` AS `r2` ON `r1`.`RelationshipsTrunkEntityRelationshipsRootEntityId` = `r2`.`RelationshipsBranchEntityRelationshipsTrunkEntityRelationshipsR~`)
LEFT JOIN `Root_RequiredReferenceTrunk_RequiredReferenceBranch_Requ72457FE0` AS `r3` ON `r1`.`RelationshipsTrunkEntityRelationshipsRootEntityId` = `r3`.`RelationshipsBranchEntityRelationshipsTrunkEntityRelationshipsR~`)
LEFT JOIN `Root_RequiredReferenceTrunk_RequiredReferenceBranch_Coll702A3AC2` AS `r4` ON `r1`.`RelationshipsTrunkEntityRelationshipsRootEntityId` = `r4`.`RelationshipsBranchEntityRelationshipsTrunkEntityRelationshipsR~`)
LEFT JOIN `Root_RequiredReferenceTrunk_RequiredReferenceBranch_Coll702A3AC2` AS `r5` ON `r1`.`RelationshipsTrunkEntityRelationshipsRootEntityId` = `r5`.`RelationshipsBranchEntityRelationshipsTrunkEntityRelationshipsR~`)
LEFT JOIN (
    SELECT `r6`.`RelationshipsTrunkEntityRelationshipsRootEntityId`, `r6`.`Id1`, `r6`.`Name`, `r7`.`RelationshipsBranchEntityRelationshipsTrunkEntityRelationshipsR~`, `r7`.`RelationshipsBranchEntityId1`, `r8`.`RelationshipsBranchEntityRelationshipsTrunkEntityRelationshipsR~` AS `RelationshipsBranchEntityRelationshipsTrunkEntityRelatio5A630C8B`, `r8`.`RelationshipsBranchEntityId1` AS `RelationshipsBranchEntityId10`, `r9`.`RelationshipsBranchEntityRelationshipsTrunkEntityRelationshipsR~` AS `RelationshipsBranchEntityRelationshipsTrunkEntityRelatio3D99058E`, `r9`.`RelationshipsBranchEntityId1` AS `RelationshipsBranchEntityId11`, `r9`.`Id1` AS `Id10`, `r9`.`Name` AS `Name0`, `r7`.`Name` AS `Name1`, `r8`.`Name` AS `Name2`
    FROM ((`Root_RequiredReferenceTrunk_CollectionBranch` AS `r6`
    LEFT JOIN `Root_RequiredReferenceTrunk_CollectionBranch_OptionalRef5715C630` AS `r7` ON `r6`.`RelationshipsTrunkEntityRelationshipsRootEntityId` = `r7`.`RelationshipsBranchEntityRelationshipsTrunkEntityRelationshipsR~` AND `r6`.`Id1` = `r7`.`RelationshipsBranchEntityId1`)
    LEFT JOIN `Root_RequiredReferenceTrunk_CollectionBranch_RequiredRef0E54E2D4` AS `r8` ON `r6`.`RelationshipsTrunkEntityRelationshipsRootEntityId` = `r8`.`RelationshipsBranchEntityRelationshipsTrunkEntityRelationshipsR~` AND `r6`.`Id1` = `r8`.`RelationshipsBranchEntityId1`)
...
LEFT JOIN `Root_OptionalReferenceTrunk_CollectionBranch_OptionalRefCCD936D2` AS `r2` ON `r1`.`RelationshipsTrunkEntityRelationshipsRootEntityId` = `r2`.`RelationshipsBranchEntityRelationshipsTrunkEntityRelationshipsR~` AND `r1`.`Id1` = `r2`.`RelationshipsBranchEntityId1`)
LEFT JOIN `Root_OptionalReferenceTrunk_CollectionBranch_RequiredRefF60F036D` AS `r3` ON `r1`.`RelationshipsTrunkEntityRelationshipsRootEntityId` = `r3`.`RelationshipsBranchEntityRelationshipsTrunkEntityRelationshipsR~` AND `r1`.`Id1` = `r3`.`RelationshipsBranchEntityId1`)
