...
public class OwnedNavigationsSetOperationsLibRedTest(
    OwnedNavigationsLibRedFixture fixture,
    ITestOutputHelper testOutputHelper)
    : OwnedNavigationsSetOperationsRelationalTestBase<OwnedNavigationsLibRedFixture>(fixture, testOutputHelper)
{
