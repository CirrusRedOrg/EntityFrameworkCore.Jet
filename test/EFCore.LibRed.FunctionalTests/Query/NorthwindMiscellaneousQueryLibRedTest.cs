        ...
        public override async Task Client_code_using_instance_method_throws(bool async)
        {
            Assert.Equal(
                CoreStrings.ClientProjectionCapturingConstantInMethodInstance(
                    "EntityFrameworkCore.LibRed.FunctionalTests.Query.NorthwindMiscellaneousQueryLibRedTest",
                    "InstanceMethod"),
        ...
        public override async Task Client_code_unknown_method(bool async)
        {
            await AssertTranslationFailedWithDetails(
                ...
                CoreStrings.QueryUnableToTranslateMethod(
                    "Microsoft.EntityFrameworkCore.Query.NorthwindMiscellaneousQueryTestBase<EntityFrameworkCore.LibRed.FunctionalTests.Query.NorthwindQueryLibRedFixture<Microsoft.EntityFrameworkCore.TestUtilities.NoopModelCustomizer>>",
