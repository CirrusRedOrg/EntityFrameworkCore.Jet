...
{
    public class FromSqlSprocQueryLibRedTest : FromSqlSprocQueryTestBase<NorthwindQueryLibRedFixture<NoopModelCustomizer>>
    {
        public FromSqlSprocQueryLibRedTest(NorthwindQueryLibRedFixture<NoopModelCustomizer> fixture)
            : base(fixture)
        {
