...
public class TPTManyToManyNoTrackingQueryJetTest : TPTManyToManyNoTrackingQueryRelationalTestBase<
    TPTManyToManyQueryJetFixture>
{
    public TPTManyToManyNoTrackingQueryJetTest(TPTManyToManyQueryJetFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
