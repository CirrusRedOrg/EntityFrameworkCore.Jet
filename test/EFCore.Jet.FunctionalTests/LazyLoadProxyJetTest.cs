...
{
    public class LazyLoadProxyJetTest : LazyLoadProxyRelationalTestBase<LazyLoadProxyJetTest.LoadJetFixture>
    {
...
";
        ...
        public class LoadJetFixture : LoadRelationalFixtureBase
        {
