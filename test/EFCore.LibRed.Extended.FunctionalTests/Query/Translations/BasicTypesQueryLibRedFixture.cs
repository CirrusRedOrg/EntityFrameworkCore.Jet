...
namespace EntityFrameworkCore.LibRed.Extended.FunctionalTests.Query.Translations;

public class BasicTypesQueryLibRedFixture : BasicTypesQueryFixtureBase, ITestSqlLoggerFactory
{
    ...
    protected override Task SeedAsync(BasicTypesContext context)
    {
        ...
        foreach (var entity in data.BasicTypesEntities)
        {
            ...
            {
                entity.DateTime = entity.DateTime.AddYears(100); // Adjust for LibRed's handling of DateTime
            }
            if (entity.DateTimeOffset.Year < 100)
            {
                entity.DateTimeOffset = entity.DateTimeOffset.AddYears(100); // Adjust for LibRed's handling of DateTimeOffset
            }
        }
        ...
        foreach (var entity in data.NullableBasicTypesEntities)
        {
            ...
            {
                entity.DateOnly = entity.DateOnly.Value.AddYears(100); // Adjust for LibRed's handling of DateOnly
            }
            if (entity.DateTime.HasValue && entity.DateTime.Value.Year < 100)
            {
                entity.DateTime = entity.DateTime.Value.AddYears(100); // Adjust for LibRed's handling of DateTime
            }
            if (entity.DateTimeOffset.HasValue && entity.DateTimeOffset.Value.Year < 100)
            {
                entity.DateTimeOffset = entity.DateTimeOffset.Value.AddYears(100); // Adjust for LibRed's handling of DateTimeOffset
            }
        }
    ...
    public override ISetSource GetExpectedData()
    {
        ...
        result.BasicTypesEntities.ForEach(b =>
        {
            ...
            {
                b.DateTime = b.DateTime.AddYears(100); // Adjust for LibRed's handling of DateTime
            }
            if (b.DateTimeOffset.Year < 100)
            {
                b.DateTimeOffset = b.DateTimeOffset.AddYears(100); // Adjust for LibRed's handling of DateTimeOffset
            }
        });
        ...
        result.NullableBasicTypesEntities.ForEach(b =>
        {
            ...
            {
                b.DateOnly = b.DateOnly.Value.AddYears(100); // Adjust for LibRed's handling of DateOnly
            }
            if (b.DateTime.HasValue && b.DateTime.Value.Year < 100)
            {
                b.DateTime = b.DateTime.Value.AddYears(100); // Adjust for LibRed's handling of DateTime
            }
            if (b.DateTimeOffset.HasValue && b.DateTimeOffset.Value.Year < 100)
            {
                b.DateTimeOffset = b.DateTimeOffset.Value.AddYears(100); // Adjust for LibRed's handling of DateTimeOffset
            }
        });
