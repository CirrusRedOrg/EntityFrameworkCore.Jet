...
{
    public class StoreGeneratedFixupLibRedTest(StoreGeneratedFixupLibRedTest.StoreGeneratedFixupLibRedFixture fixture)
        : StoreGeneratedFixupRelationalTestBase<
            StoreGeneratedFixupLibRedTest.StoreGeneratedFixupLibRedFixture>(fixture)
    {
        [Fact]
        ...
        public class StoreGeneratedFixupLibRedFixture : StoreGeneratedFixupRelationalFixtureBase
        {
