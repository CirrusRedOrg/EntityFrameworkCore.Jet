...
{
    public class FunkyDataQueryLibRedTest : FunkyDataQueryTestBase<FunkyDataQueryLibRedTest.FunkyDataQueryLibRedFixture>
    {
        public FunkyDataQueryLibRedTest(FunkyDataQueryLibRedFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
...
""");
        ...
        public class FunkyDataQueryLibRedFixture : FunkyDataQueryFixtureBase, ITestSqlLoggerFactory
        {
