...
namespace TestNamespace
{
    public partial class DbContextModel
    {
        ...
        private IRelationalModel CreateRelationalModel()
        {
            ...
            var idColumnBase0 = new ColumnBase<ColumnMappingBase>("Id", "decimal(20,0)", microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalBaseTableBase);
            ...
            var principalDerivedDependentBasebyteIdColumnBase = new ColumnBase<ColumnMappingBase>("PrincipalDerived<DependentBase<byte?>>Id", "decimal(20,0)", microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalBaseTableBase)
            {
                IsNullable = true
            };
            ...
            var idColumn0 = new Column("Id", "decimal(20,0)", principalBaseTable);
            ...
            var principalDerivedDependentBasebyteIdColumn = new Column("PrincipalDerived<DependentBase<byte?>>Id", "decimal(20,0)", principalBaseTable)
            {
                IsNullable = true
            };
            ...
            var principalDerivedIdViewColumn = new ViewColumn("PrincipalDerivedId", "decimal(20,0)", principalBaseViewView)
            {
                IsNullable = true
            };
            ...
            var id_OriginalParameter = new StoreStoredProcedureParameter("Id_Original", "decimal(20,0)", 0, principalBase_DeleteStoreSproc, System.Data.ParameterDirection.Input);
            principalBase_DeleteStoreSproc.AddParameter(id_OriginalParameter);
            var rowsAffectedParameter = new StoreStoredProcedureParameter("RowsAffected", "integer", 1, principalBase_DeleteStoreSproc, System.Data.ParameterDirection.Output);
            ...
            var idParameter = new StoreStoredProcedureParameter("Id", "decimal(20,0)", 0, principalBase_InsertStoreSproc, System.Data.ParameterDirection.Input);
            principalBase_InsertStoreSproc.AddParameter(idParameter);
            var principalBaseIdParameter = new StoreStoredProcedureParameter("PrincipalBaseId", "decimal(20,0)", 1, principalBase_InsertStoreSproc, System.Data.ParameterDirection.Input)
            {
                IsNullable = true
            };
            principalBase_InsertStoreSproc.AddParameter(principalBaseIdParameter);
            var principalDerivedIdParameter = new StoreStoredProcedureParameter("PrincipalDerivedId", "decimal(20,0)", 2, principalBase_InsertStoreSproc, System.Data.ParameterDirection.Input)
            {
                IsNullable = true
            };
            principalBase_InsertStoreSproc.AddParameter(principalDerivedIdParameter);
            var enum2Parameter = new StoreStoredProcedureParameter("Enum2", "integer", 3, principalBase_InsertStoreSproc, System.Data.ParameterDirection.Input)
            {
                IsNullable = true
            };
            principalBase_InsertStoreSproc.AddParameter(enum2Parameter);
            var flagsEnum1Parameter = new StoreStoredProcedureParameter("FlagsEnum1", "integer", 4, principalBase_InsertStoreSproc, System.Data.ParameterDirection.Input);
            principalBase_InsertStoreSproc.AddParameter(flagsEnum1Parameter);
            var flagsEnum2Parameter = new StoreStoredProcedureParameter("FlagsEnum2", "integer", 5, principalBase_InsertStoreSproc, System.Data.ParameterDirection.Input);
            principalBase_InsertStoreSproc.AddParameter(flagsEnum2Parameter);
            var valueTypeListParameter = new StoreStoredProcedureParameter("ValueTypeList", "varchar(255)", 6, principalBase_InsertStoreSproc, System.Data.ParameterDirection.Input)
            {
                IsNullable = true
            };
            principalBase_InsertStoreSproc.AddParameter(valueTypeListParameter);
            var valueTypeIListParameter = new StoreStoredProcedureParameter("ValueTypeIList", "varchar(255)", 7, principalBase_InsertStoreSproc, System.Data.ParameterDirection.Input)
            {
                IsNullable = true
            };
            principalBase_InsertStoreSproc.AddParameter(valueTypeIListParameter);
            var valueTypeArrayParameter = new StoreStoredProcedureParameter("ValueTypeArray", "varchar(255)", 8, principalBase_InsertStoreSproc, System.Data.ParameterDirection.Input)
            {
                IsNullable = true
            };
            principalBase_InsertStoreSproc.AddParameter(valueTypeArrayParameter);
            var valueTypeEnumerableParameter = new StoreStoredProcedureParameter("ValueTypeEnumerable", "varchar(255)", 9, principalBase_InsertStoreSproc, System.Data.ParameterDirection.Input)
            {
                IsNullable = true
            };
            principalBase_InsertStoreSproc.AddParameter(valueTypeEnumerableParameter);
            var refTypeListParameter = new StoreStoredProcedureParameter("RefTypeList", "varchar(255)", 10, principalBase_InsertStoreSproc, System.Data.ParameterDirection.Input)
            {
                IsNullable = true
            };
            principalBase_InsertStoreSproc.AddParameter(refTypeListParameter);
            var refTypeIListParameter = new StoreStoredProcedureParameter("RefTypeIList", "varchar(255)", 11, principalBase_InsertStoreSproc, System.Data.ParameterDirection.Input)
            {
                IsNullable = true
            };
            principalBase_InsertStoreSproc.AddParameter(refTypeIListParameter);
            var refTypeArrayParameter = new StoreStoredProcedureParameter("RefTypeArray", "varchar(255)", 12, principalBase_InsertStoreSproc, System.Data.ParameterDirection.Input)
            {
                IsNullable = true
            };
            principalBase_InsertStoreSproc.AddParameter(refTypeArrayParameter);
            var refTypeEnumerableParameter = new StoreStoredProcedureParameter("RefTypeEnumerable", "varchar(255)", 13, principalBase_InsertStoreSproc, System.Data.ParameterDirection.Input)
            {
                IsNullable = true
            };
            principalBase_InsertStoreSproc.AddParameter(refTypeEnumerableParameter);
            var baseEnumParameter = new StoreStoredProcedureParameter("BaseEnum", "integer", 14, principalBase_InsertStoreSproc, System.Data.ParameterDirection.Output);
            ...
            var principalDerivedIdParameter0 = new StoreStoredProcedureParameter("PrincipalDerivedId", "decimal(20,0)", 1, principalBase_UpdateStoreSproc, System.Data.ParameterDirection.Input)
            {
                IsNullable = true
            };
            principalBase_UpdateStoreSproc.AddParameter(principalDerivedIdParameter0);
            var enum1Parameter = new StoreStoredProcedureParameter("Enum1", "integer", 2, principalBase_UpdateStoreSproc, System.Data.ParameterDirection.Input);
            principalBase_UpdateStoreSproc.AddParameter(enum1Parameter);
            var enum2Parameter0 = new StoreStoredProcedureParameter("Enum2", "integer", 3, principalBase_UpdateStoreSproc, System.Data.ParameterDirection.Input)
            {
                IsNullable = true
            };
            principalBase_UpdateStoreSproc.AddParameter(enum2Parameter0);
            var flagsEnum1Parameter0 = new StoreStoredProcedureParameter("FlagsEnum1", "integer", 4, principalBase_UpdateStoreSproc, System.Data.ParameterDirection.Input);
            principalBase_UpdateStoreSproc.AddParameter(flagsEnum1Parameter0);
            var flagsEnum2Parameter0 = new StoreStoredProcedureParameter("FlagsEnum2", "integer", 5, principalBase_UpdateStoreSproc, System.Data.ParameterDirection.Input);
            principalBase_UpdateStoreSproc.AddParameter(flagsEnum2Parameter0);
            var valueTypeListParameter0 = new StoreStoredProcedureParameter("ValueTypeList", "varchar(255)", 6, principalBase_UpdateStoreSproc, System.Data.ParameterDirection.Input)
            {
                IsNullable = true
            };
            principalBase_UpdateStoreSproc.AddParameter(valueTypeListParameter0);
            var valueTypeIListParameter0 = new StoreStoredProcedureParameter("ValueTypeIList", "varchar(255)", 7, principalBase_UpdateStoreSproc, System.Data.ParameterDirection.Input)
            {
                IsNullable = true
            };
            principalBase_UpdateStoreSproc.AddParameter(valueTypeIListParameter0);
            var valueTypeArrayParameter0 = new StoreStoredProcedureParameter("ValueTypeArray", "varchar(255)", 8, principalBase_UpdateStoreSproc, System.Data.ParameterDirection.Input)
            {
                IsNullable = true
            };
            principalBase_UpdateStoreSproc.AddParameter(valueTypeArrayParameter0);
            var valueTypeEnumerableParameter0 = new StoreStoredProcedureParameter("ValueTypeEnumerable", "varchar(255)", 9, principalBase_UpdateStoreSproc, System.Data.ParameterDirection.Input)
            {
                IsNullable = true
            };
            principalBase_UpdateStoreSproc.AddParameter(valueTypeEnumerableParameter0);
            var refTypeListParameter0 = new StoreStoredProcedureParameter("RefTypeList", "varchar(255)", 10, principalBase_UpdateStoreSproc, System.Data.ParameterDirection.Input)
            {
                IsNullable = true
            };
            principalBase_UpdateStoreSproc.AddParameter(refTypeListParameter0);
            var refTypeIListParameter0 = new StoreStoredProcedureParameter("RefTypeIList", "varchar(255)", 11, principalBase_UpdateStoreSproc, System.Data.ParameterDirection.Input)
            {
                IsNullable = true
            };
            principalBase_UpdateStoreSproc.AddParameter(refTypeIListParameter0);
            var refTypeArrayParameter0 = new StoreStoredProcedureParameter("RefTypeArray", "varchar(255)", 12, principalBase_UpdateStoreSproc, System.Data.ParameterDirection.Input)
            {
                IsNullable = true
            };
            principalBase_UpdateStoreSproc.AddParameter(refTypeArrayParameter0);
            var refTypeEnumerableParameter0 = new StoreStoredProcedureParameter("RefTypeEnumerable", "varchar(255)", 13, principalBase_UpdateStoreSproc, System.Data.ParameterDirection.Input)
            {
                IsNullable = true
            };
            principalBase_UpdateStoreSproc.AddParameter(refTypeEnumerableParameter0);
            var id_OriginalParameter0 = new StoreStoredProcedureParameter("Id_Original", "decimal(20,0)", 14, principalBase_UpdateStoreSproc, System.Data.ParameterDirection.Input);
            ...
            var enum1ColumnBase0 = new ColumnBase<ColumnMappingBase>("Enum1", "integer", microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalDerivedMicrosoftEntityFrameworkCoreScaffoldingCompiledModelTestBaseDependentBasebyteTableBase);
            ...
            var enum2ColumnBase0 = new ColumnBase<ColumnMappingBase>("Enum2", "integer", microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalDerivedMicrosoftEntityFrameworkCoreScaffoldingCompiledModelTestBaseDependentBasebyteTableBase)
            {
                IsNullable = true
            };
            ...
            var flagsEnum1ColumnBase0 = new ColumnBase<ColumnMappingBase>("FlagsEnum1", "integer", microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalDerivedMicrosoftEntityFrameworkCoreScaffoldingCompiledModelTestBaseDependentBasebyteTableBase);
            ...
            var flagsEnum2ColumnBase0 = new ColumnBase<ColumnMappingBase>("FlagsEnum2", "integer", microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalDerivedMicrosoftEntityFrameworkCoreScaffoldingCompiledModelTestBaseDependentBasebyteTableBase);
            ...
            var idColumnBase1 = new ColumnBase<ColumnMappingBase>("Id", "decimal(20,0)", microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalDerivedMicrosoftEntityFrameworkCoreScaffoldingCompiledModelTestBaseDependentBasebyteTableBase);
            ...
            var principalBaseIdColumnBase0 = new ColumnBase<ColumnMappingBase>("PrincipalBaseId", "decimal(20,0)", microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalDerivedMicrosoftEntityFrameworkCoreScaffoldingCompiledModelTestBaseDependentBasebyteTableBase)
            {
                IsNullable = true
            };
            ...
            var principalDerivedDependentBasebyteIdColumnBase0 = new ColumnBase<ColumnMappingBase>("PrincipalDerived<DependentBase<byte?>>Id", "decimal(20,0)", microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalDerivedMicrosoftEntityFrameworkCoreScaffoldingCompiledModelTestBaseDependentBasebyteTableBase)
            {
                IsNullable = true
            };
            ...
            var refTypeArrayColumnBase0 = new ColumnBase<ColumnMappingBase>("RefTypeArray", "varchar(255)", microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalDerivedMicrosoftEntityFrameworkCoreScaffoldingCompiledModelTestBaseDependentBasebyteTableBase)
            {
                IsNullable = true
            };
            ...
            var refTypeEnumerableColumnBase0 = new ColumnBase<ColumnMappingBase>("RefTypeEnumerable", "varchar(255)", microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalDerivedMicrosoftEntityFrameworkCoreScaffoldingCompiledModelTestBaseDependentBasebyteTableBase)
            {
                IsNullable = true
            };
            ...
            var refTypeIListColumnBase0 = new ColumnBase<ColumnMappingBase>("RefTypeIList", "varchar(255)", microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalDerivedMicrosoftEntityFrameworkCoreScaffoldingCompiledModelTestBaseDependentBasebyteTableBase)
            {
                IsNullable = true
            };
            ...
            var refTypeListColumnBase0 = new ColumnBase<ColumnMappingBase>("RefTypeList", "varchar(255)", microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalDerivedMicrosoftEntityFrameworkCoreScaffoldingCompiledModelTestBaseDependentBasebyteTableBase)
            {
                IsNullable = true
            };
            ...
            var valueTypeArrayColumnBase0 = new ColumnBase<ColumnMappingBase>("ValueTypeArray", "varchar(255)", microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalDerivedMicrosoftEntityFrameworkCoreScaffoldingCompiledModelTestBaseDependentBasebyteTableBase)
            {
                IsNullable = true
            };
            ...
            var valueTypeEnumerableColumnBase0 = new ColumnBase<ColumnMappingBase>("ValueTypeEnumerable", "varchar(255)", microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalDerivedMicrosoftEntityFrameworkCoreScaffoldingCompiledModelTestBaseDependentBasebyteTableBase)
            {
                IsNullable = true
            };
            ...
            var valueTypeIListColumnBase0 = new ColumnBase<ColumnMappingBase>("ValueTypeIList", "varchar(255)", microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalDerivedMicrosoftEntityFrameworkCoreScaffoldingCompiledModelTestBaseDependentBasebyteTableBase)
            {
                IsNullable = true
            };
            ...
            var valueTypeListColumnBase0 = new ColumnBase<ColumnMappingBase>("ValueTypeList", "varchar(255)", microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalDerivedMicrosoftEntityFrameworkCoreScaffoldingCompiledModelTestBaseDependentBasebyteTableBase)
            {
                IsNullable = true
            };
            ...
            var idColumn1 = new Column("Id", "decimal(20,0)", principalDerivedTable);
            principalDerivedTable.Columns.Add("Id", idColumn1);
            idColumn1.Accessors = ColumnAccessorsFactory.CreateGeneric<long>(idColumn1);
            var enum1Column0 = new Column("Enum1", "integer", principalDerivedTable);
            ...
            var enum2Column0 = new Column("Enum2", "integer", principalDerivedTable)
            {
                IsNullable = true
            };
            ...
            var flagsEnum1Column0 = new Column("FlagsEnum1", "integer", principalDerivedTable);
            ...
            var flagsEnum2Column0 = new Column("FlagsEnum2", "integer", principalDerivedTable);
            ...
            var principalBaseIdColumn0 = new Column("PrincipalBaseId", "decimal(20,0)", principalDerivedTable)
            {
                IsNullable = true
            };
            ...
            var principalDerivedDependentBasebyteIdColumn0 = new Column("PrincipalDerived<DependentBase<byte?>>Id", "decimal(20,0)", principalDerivedTable)
            {
                IsNullable = true
            };
            ...
            var refTypeArrayColumn0 = new Column("RefTypeArray", "varchar(255)", principalDerivedTable)
            {
                IsNullable = true
            };
            ...
            var refTypeEnumerableColumn0 = new Column("RefTypeEnumerable", "varchar(255)", principalDerivedTable)
            {
                IsNullable = true
            };
            ...
            var refTypeIListColumn0 = new Column("RefTypeIList", "varchar(255)", principalDerivedTable)
            {
                IsNullable = true
            };
            ...
            var refTypeListColumn0 = new Column("RefTypeList", "varchar(255)", principalDerivedTable)
            {
                IsNullable = true
            };
            ...
            var valueTypeArrayColumn0 = new Column("ValueTypeArray", "varchar(255)", principalDerivedTable)
            {
                IsNullable = true
            };
            ...
            var valueTypeEnumerableColumn0 = new Column("ValueTypeEnumerable", "varchar(255)", principalDerivedTable)
            {
                IsNullable = true
            };
            ...
            var valueTypeIListColumn0 = new Column("ValueTypeIList", "varchar(255)", principalDerivedTable)
            {
                IsNullable = true
            };
            ...
            var valueTypeListColumn0 = new Column("ValueTypeList", "varchar(255)", principalDerivedTable)
            {
                IsNullable = true
            };
            ...
            var enum1ViewColumn0 = new ViewColumn("Enum1", "integer", principalDerivedViewView);
            principalDerivedViewView.Columns.Add("Enum1", enum1ViewColumn0);
            var enum2ViewColumn0 = new ViewColumn("Enum2", "integer", principalDerivedViewView)
            {
                IsNullable = true
            };
            principalDerivedViewView.Columns.Add("Enum2", enum2ViewColumn0);
            var flagsEnum1ViewColumn0 = new ViewColumn("FlagsEnum1", "integer", principalDerivedViewView);
            principalDerivedViewView.Columns.Add("FlagsEnum1", flagsEnum1ViewColumn0);
            var flagsEnum2ViewColumn0 = new ViewColumn("FlagsEnum2", "integer", principalDerivedViewView);
            principalDerivedViewView.Columns.Add("FlagsEnum2", flagsEnum2ViewColumn0);
            var idViewColumn0 = new ViewColumn("Id", "decimal(20,0)", principalDerivedViewView);
            principalDerivedViewView.Columns.Add("Id", idViewColumn0);
            var principalBaseIdViewColumn0 = new ViewColumn("PrincipalBaseId", "decimal(20,0)", principalDerivedViewView)
            {
                IsNullable = true
            };
            principalDerivedViewView.Columns.Add("PrincipalBaseId", principalBaseIdViewColumn0);
            var principalDerivedIdViewColumn0 = new ViewColumn("PrincipalDerivedId", "decimal(20,0)", principalDerivedViewView)
            {
                IsNullable = true
            };
            principalDerivedViewView.Columns.Add("PrincipalDerivedId", principalDerivedIdViewColumn0);
            var refTypeArrayViewColumn0 = new ViewColumn("RefTypeArray", "varchar(255)", principalDerivedViewView)
            {
                IsNullable = true
            };
            principalDerivedViewView.Columns.Add("RefTypeArray", refTypeArrayViewColumn0);
            var refTypeEnumerableViewColumn0 = new ViewColumn("RefTypeEnumerable", "varchar(255)", principalDerivedViewView)
            {
                IsNullable = true
            };
            principalDerivedViewView.Columns.Add("RefTypeEnumerable", refTypeEnumerableViewColumn0);
            var refTypeIListViewColumn0 = new ViewColumn("RefTypeIList", "varchar(255)", principalDerivedViewView)
            {
                IsNullable = true
            };
            principalDerivedViewView.Columns.Add("RefTypeIList", refTypeIListViewColumn0);
            var refTypeListViewColumn0 = new ViewColumn("RefTypeList", "varchar(255)", principalDerivedViewView)
            {
                IsNullable = true
            };
            principalDerivedViewView.Columns.Add("RefTypeList", refTypeListViewColumn0);
            var valueTypeArrayViewColumn0 = new ViewColumn("ValueTypeArray", "varchar(255)", principalDerivedViewView)
            {
                IsNullable = true
            };
            principalDerivedViewView.Columns.Add("ValueTypeArray", valueTypeArrayViewColumn0);
            var valueTypeEnumerableViewColumn0 = new ViewColumn("ValueTypeEnumerable", "varchar(255)", principalDerivedViewView)
            {
                IsNullable = true
            };
            principalDerivedViewView.Columns.Add("ValueTypeEnumerable", valueTypeEnumerableViewColumn0);
            var valueTypeIListViewColumn0 = new ViewColumn("ValueTypeIList", "varchar(255)", principalDerivedViewView)
            {
                IsNullable = true
            };
            principalDerivedViewView.Columns.Add("ValueTypeIList", valueTypeIListViewColumn0);
            var valueTypeListViewColumn0 = new ViewColumn("ValueTypeList", "varchar(255)", principalDerivedViewView)
            {
                IsNullable = true
            };
            ...
            var id_OriginalParameter1 = new StoreStoredProcedureParameter("Id_Original", "decimal(20,0)", 0, derived_DeleteStoreSproc, System.Data.ParameterDirection.Input);
            ...
            var idParameter0 = new StoreStoredProcedureParameter("Id", "decimal(20,0)", 0, derived_InsertStoreSproc, System.Data.ParameterDirection.Input);
            derived_InsertStoreSproc.AddParameter(idParameter0);
            var principalBaseIdParameter1 = new StoreStoredProcedureParameter("PrincipalBaseId", "decimal(20,0)", 1, derived_InsertStoreSproc, System.Data.ParameterDirection.Input)
            {
                IsNullable = true
            };
            derived_InsertStoreSproc.AddParameter(principalBaseIdParameter1);
            var principalDerivedIdParameter1 = new StoreStoredProcedureParameter("PrincipalDerivedId", "decimal(20,0)", 2, derived_InsertStoreSproc, System.Data.ParameterDirection.Input)
            {
                IsNullable = true
            };
            derived_InsertStoreSproc.AddParameter(principalDerivedIdParameter1);
            var enum2Parameter1 = new StoreStoredProcedureParameter("Enum2", "integer", 3, derived_InsertStoreSproc, System.Data.ParameterDirection.Input)
            {
                IsNullable = true
            };
            derived_InsertStoreSproc.AddParameter(enum2Parameter1);
            var flagsEnum1Parameter1 = new StoreStoredProcedureParameter("FlagsEnum1", "integer", 4, derived_InsertStoreSproc, System.Data.ParameterDirection.Input);
            derived_InsertStoreSproc.AddParameter(flagsEnum1Parameter1);
            var flagsEnum2Parameter1 = new StoreStoredProcedureParameter("FlagsEnum2", "integer", 5, derived_InsertStoreSproc, System.Data.ParameterDirection.Input);
            derived_InsertStoreSproc.AddParameter(flagsEnum2Parameter1);
            var valueTypeListParameter1 = new StoreStoredProcedureParameter("ValueTypeList", "varchar(255)", 6, derived_InsertStoreSproc, System.Data.ParameterDirection.Input)
            {
                IsNullable = true
            };
            derived_InsertStoreSproc.AddParameter(valueTypeListParameter1);
            var valueTypeIListParameter1 = new StoreStoredProcedureParameter("ValueTypeIList", "varchar(255)", 7, derived_InsertStoreSproc, System.Data.ParameterDirection.Input)
            {
                IsNullable = true
            };
            derived_InsertStoreSproc.AddParameter(valueTypeIListParameter1);
            var valueTypeArrayParameter1 = new StoreStoredProcedureParameter("ValueTypeArray", "varchar(255)", 8, derived_InsertStoreSproc, System.Data.ParameterDirection.Input)
            {
                IsNullable = true
            };
            derived_InsertStoreSproc.AddParameter(valueTypeArrayParameter1);
            var valueTypeEnumerableParameter1 = new StoreStoredProcedureParameter("ValueTypeEnumerable", "varchar(255)", 9, derived_InsertStoreSproc, System.Data.ParameterDirection.Input)
            {
                IsNullable = true
            };
            derived_InsertStoreSproc.AddParameter(valueTypeEnumerableParameter1);
            var refTypeListParameter1 = new StoreStoredProcedureParameter("RefTypeList", "varchar(255)", 10, derived_InsertStoreSproc, System.Data.ParameterDirection.Input)
            {
                IsNullable = true
            };
            derived_InsertStoreSproc.AddParameter(refTypeListParameter1);
            var refTypeIListParameter1 = new StoreStoredProcedureParameter("RefTypeIList", "varchar(255)", 11, derived_InsertStoreSproc, System.Data.ParameterDirection.Input)
            {
                IsNullable = true
            };
            derived_InsertStoreSproc.AddParameter(refTypeIListParameter1);
            var refTypeArrayParameter1 = new StoreStoredProcedureParameter("RefTypeArray", "varchar(255)", 12, derived_InsertStoreSproc, System.Data.ParameterDirection.Input)
            {
                IsNullable = true
            };
            derived_InsertStoreSproc.AddParameter(refTypeArrayParameter1);
            var refTypeEnumerableParameter1 = new StoreStoredProcedureParameter("RefTypeEnumerable", "varchar(255)", 13, derived_InsertStoreSproc, System.Data.ParameterDirection.Input)
            {
                IsNullable = true
            };
            derived_InsertStoreSproc.AddParameter(refTypeEnumerableParameter1);
            var derivedEnumFunctionColumn = new StoreStoredProcedureResultColumn("DerivedEnum", "integer", 0, derived_InsertStoreSproc);
            ...
            var principalBaseIdParameter2 = new StoreStoredProcedureParameter("PrincipalBaseId", "decimal(20,0)", 0, derived_UpdateStoreSproc, System.Data.ParameterDirection.Input)
            {
                IsNullable = true
            };
            derived_UpdateStoreSproc.AddParameter(principalBaseIdParameter2);
            var principalDerivedIdParameter2 = new StoreStoredProcedureParameter("PrincipalDerivedId", "decimal(20,0)", 1, derived_UpdateStoreSproc, System.Data.ParameterDirection.Input)
            {
                IsNullable = true
            };
            derived_UpdateStoreSproc.AddParameter(principalDerivedIdParameter2);
            var enum1Parameter0 = new StoreStoredProcedureParameter("Enum1", "integer", 2, derived_UpdateStoreSproc, System.Data.ParameterDirection.Input);
            derived_UpdateStoreSproc.AddParameter(enum1Parameter0);
            var enum2Parameter2 = new StoreStoredProcedureParameter("Enum2", "integer", 3, derived_UpdateStoreSproc, System.Data.ParameterDirection.Input)
            {
                IsNullable = true
            };
            derived_UpdateStoreSproc.AddParameter(enum2Parameter2);
            var flagsEnum1Parameter2 = new StoreStoredProcedureParameter("FlagsEnum1", "integer", 4, derived_UpdateStoreSproc, System.Data.ParameterDirection.Input);
            derived_UpdateStoreSproc.AddParameter(flagsEnum1Parameter2);
            var flagsEnum2Parameter2 = new StoreStoredProcedureParameter("FlagsEnum2", "integer", 5, derived_UpdateStoreSproc, System.Data.ParameterDirection.Input);
            derived_UpdateStoreSproc.AddParameter(flagsEnum2Parameter2);
            var valueTypeListParameter2 = new StoreStoredProcedureParameter("ValueTypeList", "varchar(255)", 6, derived_UpdateStoreSproc, System.Data.ParameterDirection.Input)
            {
                IsNullable = true
            };
            derived_UpdateStoreSproc.AddParameter(valueTypeListParameter2);
            var valueTypeIListParameter2 = new StoreStoredProcedureParameter("ValueTypeIList", "varchar(255)", 7, derived_UpdateStoreSproc, System.Data.ParameterDirection.Input)
            {
                IsNullable = true
            };
            derived_UpdateStoreSproc.AddParameter(valueTypeIListParameter2);
            var valueTypeArrayParameter2 = new StoreStoredProcedureParameter("ValueTypeArray", "varchar(255)", 8, derived_UpdateStoreSproc, System.Data.ParameterDirection.Input)
            {
                IsNullable = true
            };
            derived_UpdateStoreSproc.AddParameter(valueTypeArrayParameter2);
            var valueTypeEnumerableParameter2 = new StoreStoredProcedureParameter("ValueTypeEnumerable", "varchar(255)", 9, derived_UpdateStoreSproc, System.Data.ParameterDirection.Input)
            {
                IsNullable = true
            };
            derived_UpdateStoreSproc.AddParameter(valueTypeEnumerableParameter2);
            var refTypeListParameter2 = new StoreStoredProcedureParameter("RefTypeList", "varchar(255)", 10, derived_UpdateStoreSproc, System.Data.ParameterDirection.Input)
            {
                IsNullable = true
            };
            derived_UpdateStoreSproc.AddParameter(refTypeListParameter2);
            var refTypeIListParameter2 = new StoreStoredProcedureParameter("RefTypeIList", "varchar(255)", 11, derived_UpdateStoreSproc, System.Data.ParameterDirection.Input)
            {
                IsNullable = true
            };
            derived_UpdateStoreSproc.AddParameter(refTypeIListParameter2);
            var refTypeArrayParameter2 = new StoreStoredProcedureParameter("RefTypeArray", "varchar(255)", 12, derived_UpdateStoreSproc, System.Data.ParameterDirection.Input)
            {
                IsNullable = true
            };
            derived_UpdateStoreSproc.AddParameter(refTypeArrayParameter2);
            var refTypeEnumerableParameter2 = new StoreStoredProcedureParameter("RefTypeEnumerable", "varchar(255)", 13, derived_UpdateStoreSproc, System.Data.ParameterDirection.Input)
            {
                IsNullable = true
            };
            derived_UpdateStoreSproc.AddParameter(refTypeEnumerableParameter2);
            var id_OriginalParameter2 = new StoreStoredProcedureParameter("Id_Original", "decimal(20,0)", 14, derived_UpdateStoreSproc, System.Data.ParameterDirection.Input);
