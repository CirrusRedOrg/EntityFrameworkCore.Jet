...
public class OwnedNavigationsMiscellaneousLibRedTest(
    OwnedNavigationsLibRedFixture fixture,
    ITestOutputHelper testOutputHelper)
    : OwnedNavigationsMiscellaneousRelationalTestBase<OwnedNavigationsLibRedFixture>(fixture, testOutputHelper)
{
